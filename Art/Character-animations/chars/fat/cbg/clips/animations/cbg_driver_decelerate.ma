...
//Name: cbg_driver_decelerate.ma
//Last modified: Fri, Aug 02, 2002 01:33:35 PM
requires maya "4.0";
...
createNode animClip -n "cbg_driver_decelerateSource";
	setAttr ".ihi" 0;
	setAttr ".du" 55;
	setAttr ".ci" no;
...
select -ne :hyperGraphLayout;
	...
	setAttr ".ims" 1;
select -ne :ikSystem;
connectAttr "cbg_driver_decelerateSource.st" "clipLibrary1.st[0]";
connectAttr "cbg_driver_decelerateSource.du" "clipLibrary1.du[0]";
...
// End of cbg_driver_decelerate.ma
