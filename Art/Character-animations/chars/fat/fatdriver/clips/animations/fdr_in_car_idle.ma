...
//Name: fdr_in_car_idle.ma
//Last modified: Wed, Aug 14, 2002 02:49:14 PM
requires maya "4.0";
requires "p3dmayaexp" "18.2";
requires "p3dSimpleShader" "18.0";
requires "WorldBuilder" "3.0";
currentUnit -l meter -a degree -t ntsc;
createNode animClip -n "fdr_in_car_idleSource";
	setAttr ".ihi" 0;
	setAttr ".du" 45;
	setAttr ".ci" no;
...
createNode animCurveTA -n "fdr_Motion_Root_rotateY";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr ".ktv[0]"  31 0;
...
select -ne :hyperGraphLayout;
	...
	setAttr ".ims" 1;
select -ne :ikSystem;
connectAttr "fdr_in_car_idleSource.st" "clipLibrary1.st[0]";
connectAttr "fdr_in_car_idleSource.du" "clipLibrary1.du[0]";
...
connectAttr "Motion_Root_translateZ.a" "clipLibrary1.cel[0].cev[4].cevr"
		;
connectAttr "fdr_Motion_Root_rotateY.a" "clipLibrary1.cel[0].cev[5].cevr"
		;
