...
//Name: brt_surf_out.ma
//Last modified: Tue, May 27, 2003 01:56:22 PM
requires maya "4.0";
requires "p3dDeformer" "2.0";
requires "p3dmayaexp" "2.0.3.0";
requires "p3dSimpleShader" "2.0";
currentUnit -l meter -a degree -t ntsc;
createNode animClip -n "brt_surf_outSource";
	setAttr ".ihi" 0;
	setAttr ".st" 86;
	setAttr ".du" 4;
	setAttr ".ci" no;
...
select -ne :hyperGraphLayout;
	...
	setAttr ".ims" 1;
select -ne :ikSystem;
connectAttr "brt_surf_outSource.st" "clipLibrary2.st[0]";
connectAttr "brt_surf_outSource.du" "clipLibrary2.du[0]";
