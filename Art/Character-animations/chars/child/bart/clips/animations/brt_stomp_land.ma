...
//Name: brt_stomp_land.ma
//Last modified: Tue, May 27, 2003 01:54:39 PM
requires maya "4.0";
requires "p3dDeformer" "2.0";
requires "p3dmayaexp" "2.0.3.0";
requires "p3dSimpleShader" "2.0";
currentUnit -l meter -a degree -t ntsc;
createNode animClip -n "brt_stomp_landSource";
	setAttr ".ihi" 0;
	setAttr ".du" 23;
	setAttr ".ci" no;
...
createNode animCurveTL -n "Motion_Root_translateX";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 17 ".ktv[0:16]"  0 -0.015355166327487733 1 -0.016931495506146987 
		2 -0.018446329398252571 3 -0.019875069889183 4 -0.021193118864316816 5 -0.022375878209032533 
		6 -0.02339874980870869 7 -0.024237135548723827 8 -0.024866437314456449 9 
		-0.025262056991285111 10 -0.025399396464588324 11 -0.026012073300149041 12 
		-0.027543765389050831 13 -0.029534965104623161 14 -0.03152616482019549 22 
		-0.03305785690909728 23 -0.033670533744657997;
...
createNode animCurveTL -n "Motion_Root_translateZ";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 17 ".ktv[0:16]"  0 0.033248409555833455 1 0.03346566423748356 
		2 0.033674443443906736 3 0.033871356985012223 4 0.034053014670709245 5 0.03421602631090704 
		6 0.034357001715514847 7 0.034472550694441877 8 0.034559283057597374 9 0.034613808614890579 
		10 0.0346327371762307 11 0.032067349237250652 12 0.025653879389800519 13 
		0.017316368588115354 14 0.0089788577864301864 22 0.0025653879389800566 23 
		0;
...
createNode animCurveTL -n "Right_Foot_Hoop_translateX";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  0 -0.13696034662847295 2 -0.20680453599946191 
		9 -0.20680453599946191;
createNode animCurveTL -n "Right_Foot_Hoop_translateY";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  0 1.3379358635967142 2 0.43685116521245315 
		5 1.3775616625838913 9 0.18987362901403823;
createNode animCurveTL -n "Right_Foot_Hoop_translateZ";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  0 -0.45908512056662931 2 -0.2741480131556488 
		5 0.15566137513419304 9 -0.11771537289923364;
createNode animCurveTA -n "Right_Foot_Hoop_rotateX";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 6 ".ktv[0:5]"  0 -169.16720554150803 2 -278.69605649788997 
		5 -397.51319294443999 9 -397.51319294443999 10 -363.1576645785301 23 -360;
createNode animCurveTA -n "Right_Foot_Hoop_rotateY";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 2 ".ktv[0:1]"  0 5.7567799081279789 9 -25.948901905116401;
createNode animCurveTA -n "Right_Foot_Hoop_rotateZ";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 2 ".ktv[0:1]"  0 9.4120496621549901 9 0;
createNode animCurveTL -n "Left_Foot_Hoop_translateX";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 6 ".ktv[0:5]"  0 0.11655402360090404 2 0.24024264043683283 
		5 0.4014051689200393 9 0.24333392531227596 10 0.21600000000000003 23 0.21600000000000003;
	setAttr -s 6 ".kit[2:5]"  3 9 3 3;
	setAttr -s 6 ".kot[2:5]"  3 9 3 3;
createNode animCurveTL -n "Left_Foot_Hoop_translateY";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 6 ".ktv[0:5]"  0 1.4041934063037069 2 0.56150690518035307 
		5 1.4555884906448611 9 0.19285174209233688 10 0.219 23 0.219;
	setAttr -s 6 ".kit[3:5]"  3 3 3;
	setAttr -s 6 ".kot[3:5]"  3 3 3;
createNode animCurveTL -n "Left_Foot_Hoop_translateZ";
	setAttr ".tan" 3;
	setAttr ".wgt" no;
	setAttr -s 6 ".ktv[0:5]"  0 -0.10303249488023265 2 -0.29554787545062172 
		5 0.17302373849117214 9 0.079131516641668287 10 0.001 23 0.001;
	setAttr -s 6 ".kit[0:5]"  9 9 3 3 3 3;
	setAttr -s 6 ".kot[0:5]"  9 9 3 3 3 3;
createNode animCurveTA -n "Left_Foot_Hoop_rotateX";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 6 ".ktv[0:5]"  0 -163.68995775419228 2 -273.8468713246732 
		5 -395.78327963936084 9 -395.78327963936084 10 -360 23 -360;
	setAttr -s 6 ".kit[3:5]"  3 3 3;
	setAttr -s 6 ".kot[3:5]"  3 3 3;
createNode animCurveTA -n "Left_Foot_Hoop_rotateY";
	setAttr ".tan" 3;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  0 26.8757648896161 9 4.2298117252192542 
		10 0 23 0;
...
createNode animCurveTA -n "Left_Foot_Hoop_rotateZ";
	setAttr ".tan" 3;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  0 8.9981869141364079 9 10.798151366798168 
		10 0 23 0;
	setAttr -s 4 ".kit[0:3]"  9 3 3 3;
	setAttr -s 4 ".kot[0:3]"  9 3 3 3;
...
createNode animCurveTL -n "Character_Hoop_translateX";
	setAttr ".tan" 3;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  0 -0.034468649615113173 10 -0.057330666212411112 
		23 -0.076;
...
createNode animCurveTL -n "Character_Hoop_translateY";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  0 0.75753835219190901 5 1.8753770000000001 
		10 0.6686478846148981 23 0.95500000000000007;
	setAttr -s 4 ".kit[2:3]"  1 3;
	setAttr -s 4 ".kot[0:3]"  1 9 3 3;
	setAttr -s 4 ".ktl[0:3]" no yes no yes;
	setAttr -s 4 ".kix[2:3]"  0.00078813784057274461 1;
	setAttr -s 4 ".kiy[2:3]"  -0.99999970197677612 0;
	setAttr -s 4 ".kox[0:3]"  0.00086023838957771659 0.037472996860742569 
		1 1;
	setAttr -s 4 ".koy[0:3]"  0.99999964237213135 -0.9992976188659668 
		0 0;
createNode animCurveTL -n "Character_Hoop_translateZ";
	setAttr ".tan" 3;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  0 0.075020937730762238 10 0.078171853328910398 
		23 0;
	setAttr -s 3 ".kit[0:2]"  9 3 3;
	setAttr -s 3 ".kot[0:2]"  9 3 3;
createNode animCurveTA -n "Character_Hoop_rotateX";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  0 467.42048935088877 6 381.58030123388176 
		10 361.76127084074756 23 359.37200000000001;
	setAttr -s 4 ".kit[2:3]"  3 9;
	setAttr -s 4 ".kot[2:3]"  3 9;
createNode animCurveTA -n "Character_Hoop_rotateY";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  0 -11.235563850423233 6 1.0564100851721403 
		23 -5.8280000000000003;
	setAttr -s 3 ".kit[2]"  3;
	setAttr -s 3 ".kot[2]"  3;
createNode animCurveTA -n "Character_Hoop_rotateZ";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  0 -9.7162635410320757 6 -0.87610905058396449 
		23 -1.296;
	setAttr -s 3 ".kit[2]"  3;
	setAttr -s 3 ".kot[2]"  3;
...
createNode animCurveTA -n "R_FK_Shoulder_rotateX";
	setAttr ".tan" 3;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  0 -22.372233105838497 5 -68.014376880265431 
		14 29.492969798881184;
createNode animCurveTA -n "R_FK_Shoulder_rotateY";
	setAttr ".tan" 3;
	setAttr ".wgt" no;
	setAttr -s 2 ".ktv[0:1]"  0 -21.043818869343578 14 -62.038113742166672;
createNode animCurveTA -n "R_FK_Shoulder_rotateZ";
	setAttr ".tan" 3;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  0 -37.630212169444867 5 62.17457265855149 
		14 -37.564482110614925;
createNode animCurveTA -n "L_FK_Shoulder_rotateX";
	setAttr ".tan" 3;
	setAttr ".wgt" no;
	setAttr -s 2 ".ktv[0:1]"  0 -109.89795808990061 14 39.359048828530518;
	setAttr -s 2 ".kit[1]"  9;
	setAttr -s 2 ".kot[1]"  9;
createNode animCurveTA -n "L_FK_Shoulder_rotateY";
	setAttr ".tan" 3;
	setAttr ".wgt" no;
	setAttr -s 2 ".ktv[0:1]"  0 -14.848868571926861 14 -69.314798210550208;
	setAttr -s 2 ".kit[1]"  9;
	setAttr -s 2 ".kot[1]"  9;
createNode animCurveTA -n "L_FK_Shoulder_rotateZ";
	setAttr ".tan" 3;
	setAttr ".wgt" no;
	setAttr -s 2 ".ktv[0:1]"  0 87.299850500374063 14 -24.970641355053907;
	setAttr -s 2 ".kit[1]"  9;
	setAttr -s 2 ".kot[1]"  9;
createNode animCurveTA -n "R_FK_Elbow_rotateZ";
	setAttr ".tan" 3;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  0 8.3607579942612134 5 99.585917492101061 
		14 19.562015386441914;
createNode animCurveTA -n "L_FK_Elbow_rotateZ";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  0 76.545331931277303 5 25.138329081264967 
		9 64.020964792771906 14 13.184141232195005;
	setAttr -s 4 ".kit[0:3]"  3 9 9 9;
	setAttr -s 4 ".kot[0:3]"  3 9 9 9;
createNode animCurveTA -n "R_FK_Wrist_rotateX";
	setAttr ".tan" 3;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  0 21.237041284155623 5 29.03251339051516 
		14 27.932144099539396;
	setAttr -s 3 ".kit[2]"  9;
	setAttr -s 3 ".kot[2]"  9;
createNode animCurveTA -n "R_FK_Wrist_rotateY";
	setAttr ".tan" 3;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  0 20.300276010348099 5 1.0587887607632462 
		14 -5.8728416883902446;
	setAttr -s 3 ".kit[2]"  9;
	setAttr -s 3 ".kot[2]"  9;
createNode animCurveTA -n "R_FK_Wrist_rotateZ";
	setAttr ".tan" 3;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  0 -15.332488565189166 5 24.517747309106987 
		14 4.7817360779714466;
	setAttr -s 3 ".kit[2]"  9;
	setAttr -s 3 ".kot[2]"  9;
createNode animCurveTA -n "L_FK_Wrist_rotateX";
	setAttr ".tan" 3;
	setAttr ".wgt" no;
	setAttr -s 2 ".ktv[0:1]"  0 -21.398895832952157 9 -12.099754936417922;
	setAttr -s 2 ".kit[1]"  9;
	setAttr -s 2 ".kot[1]"  9;
createNode animCurveTA -n "L_FK_Wrist_rotateY";
	setAttr ".tan" 3;
	setAttr ".wgt" no;
	setAttr -s 2 ".ktv[0:1]"  0 23.744825671386987 9 -5.0684289463610597;
	setAttr -s 2 ".kit[1]"  9;
	setAttr -s 2 ".kot[1]"  9;
createNode animCurveTA -n "L_FK_Wrist_rotateZ";
	setAttr ".tan" 3;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  0 34.260678025552281 9 37.003747395100511 
		14 0;
...
createNode animCurveTA -n "Spine_2_rotateX";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 2 ".ktv[0:1]"  0 0.94961252749635683 23 -0.651;
createNode animCurveTA -n "Spine_2_rotateY";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  0 9.7361318264134411 10 0 23 -4.237;
createNode animCurveTA -n "Spine_2_rotateZ";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 2 ".ktv[0:1]"  0 5.5979561023299826 23 2.7000000000000002;
createNode animCurveTA -n "Neck_rotateX";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 2 ".ktv[0:1]"  0 5.9279256251174788 10 0;
createNode animCurveTA -n "Neck_rotateY";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 2 ".ktv[0:1]"  0 -19.047363507450704 10 0;
createNode animCurveTA -n "Neck_rotateZ";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 2 ".ktv[0:1]"  0 -27.059495145960064 10 0;
...
createNode animCurveTA -n "Head_rotateZ";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 2 ".ktv[0:1]"  0 3.3146339385901968 23 6.6790000000000003;
createNode animCurveTA -n "Spine_1_rotateX";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 2 ".ktv[0:1]"  0 0.94961252749635683 23 -1.8900000000000001;
createNode animCurveTA -n "Spine_1_rotateY";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  0 9.7361318264134411 10 0 23 2.56;
createNode animCurveTA -n "Spine_1_rotateZ";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 2 ".ktv[0:1]"  0 5.5979561023299826 23 2.017;
...
select -ne :hyperGraphLayout;
	...
	setAttr ".ims" 1;
select -ne :ikSystem;
connectAttr "brt_stomp_landSource.st" "clipLibrary1.st[0]";
connectAttr "brt_stomp_landSource.du" "clipLibrary1.du[0]";
