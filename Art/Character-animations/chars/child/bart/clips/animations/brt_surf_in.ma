...
//Name: brt_surf_in.ma
//Last modified: Tue, May 27, 2003 01:55:59 PM
requires maya "4.0";
requires "p3dDeformer" "2.0";
requires "p3dmayaexp" "2.0.3.0";
requires "p3dSimpleShader" "2.0";
currentUnit -l meter -a degree -t ntsc;
createNode animClip -n "brt_surf_inSource";
	setAttr ".ihi" 0;
	setAttr ".du" 4;
	setAttr ".ci" no;
...
select -ne :hyperGraphLayout;
	...
	setAttr ".ims" 1;
select -ne :ikSystem;
connectAttr "brt_surf_inSource.st" "clipLibrary2.st[0]";
connectAttr "brt_surf_inSource.du" "clipLibrary2.du[0]";
