...
//Name: brt_loco_dash.ma
//Last modified: Tue, May 27, 2003 01:52:16 PM
requires maya "4.0";
requires "p3dDeformer" "2.0";
requires "p3dmayaexp" "2.0.3.0";
requires "p3dSimpleShader" "2.0";
currentUnit -l meter -a degree -t ntsc;
createNode animClip -n "brt_loco_dashSource";
	setAttr ".ihi" 0;
	setAttr ".du" 16;
	setAttr ".ci" no;
createNode animCurveTL -n "Extra_Attributes_translateX";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  0 0 8 1 11 0 16 0;
	setAttr -s 4 ".kot[0:3]"  5 5 5 9;
createNode animCurveTL -n "Extra_Attributes_translateY";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  0 1 3 0 16 1;
	setAttr -s 3 ".kot[0:2]"  5 5 5;
createNode animCurveTL -n "Motion_Root_translateX";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 17 ".ktv[0:16]"  0 0.028390750446851912 1 0.025952493707038619 
		2 0.019524362302076298 3 0.010436314453681298 4 1.830838356995534e-005 5 
		-0.010399697686541391 6 -0.019487745534936395 7 -0.025915876939898719 8 -0.028354133679712002 
		9 -0.025915876939898712 10 -0.019487745534936388 11 -0.010399697686541387 
		12 1.830838356995534e-005 13 0.010436314453681301 14 0.019524362302076305 
		15 0.025952493707038633 16 0.028390750446851912;
...
createNode animCurveTL -n "Motion_Root_translateZ";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 17 ".ktv[0:16]"  0 0.28307804563719663 1 0.5540654147619376 
		2 0.82505277453707893 3 1.0960401262982788 4 1.3670274713811952 5 1.6380148111214865 
		6 1.9090021468548108 7 2.1799894799168262 8 2.4509768116431907 9 2.7219641433695627 
		10 2.9929514764315996 11 3.2639388121649615 12 3.5349261519053039 13 3.8059134969882877 
		14 4.0769008487495695 15 4.3478882085248065 16 4.6188755776496597;
...
createNode animCurveTL -n "brt_Right_Foot_Hoop_translateX";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 6 ".ktv[0:5]"  0 -0.21659272927792658 8 -0.21659272927792658 
		9 -0.21659272927792658 10 -0.21659272927792658 13 -0.2078404201298519 16 
		-0.21659272927792658;
createNode animCurveTL -n "brt_Right_Foot_Hoop_translateY";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 9 ".ktv[0:8]"  0 0.61123597879882274 2 0.38537876345199096 
		5 0.73884313753619923 7 0.36113103908524374 8 0.2245163073022689 9 0.19788269697213082 
		10 0.19788269697213082 13 0.74374429754057603 16 0.61123597879882274;
createNode animCurveTL -n "brt_Right_Foot_Hoop_translateZ";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 9 ".ktv[0:8]"  0 0.053234206658689269 2 1.6083396622255794 
		5 4.0404023862782408 7 5.4281756228007092 8 5.9263613451036683 9 6.1661760425683498 
		10 6.1661760425683498 13 8.0380066246658117 16 9.813448845997403;
createNode animCurveTA -n "brt_Right_Foot_Hoop_rotateX";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 8 ".ktv[0:7]"  0 110.2969840076761 2 92.021753139612642 
		5 -32.706809147252009 8 -58.027897743648516 9 0.80037747679751137 10 26.679119212799993 
		13 130.44108432624319 16 110.2969840076761;
createNode animCurveTA -n "brt_Right_Foot_Hoop_rotateY";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 5 ".ktv[0:4]"  0 0 8 0 9 -1.4623572118687658 10 
		-1.4623572118687658 16 0;
createNode animCurveTA -n "brt_Right_Foot_Hoop_rotateZ";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 5 ".ktv[0:4]"  0 0 8 0 9 5.9112414207691364 10 
		5.9112414207691364 16 0;
createNode animCurveTL -n "brt_Left_Foot_Hoop_translateX";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 7 ".ktv[0:6]"  0 0.21577902459239748 1 0.21577902459239748 
		2 0.20682475469462458 8 0.21577902459239748 10 0.17873387445466368 11 0.19660474041296272 
		16 0.21577902459239748;
createNode animCurveTL -n "brt_Left_Foot_Hoop_translateY";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 10 ".ktv[0:9]"  0 0.2167082224881276 1 0.2167082224881276 
		2 0.27344513724920411 5 0.89297419920615473 8 0.64935380215875171 9 0.32569864384148739 
		10 0.41560234244994065 11 0.60452343181429358 13 0.7364584804930252 16 0.2167082224881276;
createNode animCurveTL -n "brt_Left_Foot_Hoop_translateZ";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 9 ".ktv[0:8]"  0 1.0782018557052788 1 1.3118859989437874 
		2 1.3857293923882288 5 3.1149979388840432 8 5.0164216407893631 9 5.8907054538294075 
		11 7.8312294264196618 15 10.317615307998159 16 10.838416495043989;
createNode animCurveTA -n "brt_Left_Foot_Hoop_rotateX";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 11 ".ktv[0:10]"  0 -59.451138165742073 1 1.7496513253210169 
		2 15.114610409322628 5 123.08446633298112 8 103.96499167087933 9 119.32160813858367 
		10 39.462755904327814 11 2.339768408543478 13 -51.261179783427487 15 -51.565939200531545 
		16 -59.451138165742073;
createNode animCurveTA -n "brt_Left_Foot_Hoop_rotateY";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 5 ".ktv[0:4]"  0 0 1 0 2 0 8 0 16 0;
...
createNode animCurveTL -n "brt_Character_Hoop_translateX";
	setAttr ".tan" 3;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  0 0.064082650139250463 8 -0.064 
		16 0.064082650139250463;
createNode animCurveTL -n "brt_Character_Hoop_translateY";
	setAttr ".tan" 3;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  1 0.79102706840880799 5 1.116388786772371 
		9 0.79102706840880799;
	setAttr ".pre" 3;
	setAttr ".pst" 3;
createNode animCurveTL -n "brt_Character_Hoop_translateZ";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 2 ".ktv[0:1]"  0 0.63895427472515898 16 10.425571111033175;
createNode animCurveTA -n "brt_Character_Hoop_rotateX";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr ".ktv[0]"  0 -8.7574199911419708;
createNode animCurveTA -n "brt_Character_Hoop_rotateY";
	setAttr ".tan" 3;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  0 6.2752221270207533 8 -6.2750000000000004 
		16 6.2752221270207533;
...
createNode animCurveTA -n "brt_L_Ball_Fk_rotateZ";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr ".ktv[0]"  0 0.00024362833661790807;
...
createNode animCurveTL -n "brt_Right_Arm_Hoop_translateX";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr ".ktv[0]"  0 -0.99632412003841098;
createNode animCurveTL -n "brt_Right_Arm_Hoop_translateY";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr ".ktv[0]"  0 4.9698456775810258e-016;
createNode animCurveTL -n "brt_Right_Arm_Hoop_translateZ";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr ".ktv[0]"  0 0.055643269750833751;
...
createNode animCurveTA -n "brt_R_FK_Shoulder_rotateX";
	setAttr ".tan" 1;
	setAttr ".wgt" no;
	setAttr -s 5 ".ktv[0:4]"  0 -86.113178279628769 4 -14.381148048888022 
		8 26.917885283376602 12 -4.4092357888519658 16 -86.113178279628769;
	setAttr -s 5 ".kit[0:4]"  3 1 9 1 3;
	setAttr -s 5 ".kot[0:4]"  3 1 9 1 3;
	setAttr -s 5 ".kix[1:4]"  0.10831077396869659 0.83742421865463257 
		0.095734499394893646 1;
	setAttr -s 5 ".kiy[1:4]"  0.99411708116531372 0.54655343294143677 
		-0.99540692567825317 0;
	setAttr -s 5 ".kox[1:4]"  0.10831074416637421 0.83742421865463257 
		0.095734491944313049 1;
	setAttr -s 5 ".koy[1:4]"  0.99411708116531372 0.54655343294143677 
		-0.99540692567825317 0;
createNode animCurveTA -n "brt_R_FK_Shoulder_rotateY";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 5 ".ktv[0:4]"  0 -18.017812153199618 4 -61.405054067388519 
		8 -40.252967373427431 12 -45.451551028647266 16 -18.017812153199618;
	setAttr -s 5 ".kit[0:4]"  3 9 9 9 3;
	setAttr -s 5 ".kot[0:4]"  3 9 9 9 3;
createNode animCurveTA -n "brt_R_FK_Shoulder_rotateZ";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 5 ".ktv[0:4]"  0 67.738714307921029 4 23.081720144464811 
		8 -67.362532279591264 12 18.612460136224751 16 67.738714307921029;
	setAttr -s 5 ".kit[0:4]"  3 9 9 9 3;
	setAttr -s 5 ".kot[0:4]"  3 9 9 9 3;
createNode animCurveTA -n "brt_L_FK_Shoulder_rotateX";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 5 ".ktv[0:4]"  0 46.14063953601736 4 -48.006984473127545 
		8 -78.192788592859756 12 -40.373793478083925 16 46.14063953601736;
	setAttr -s 5 ".kit[0:4]"  3 9 9 9 3;
	setAttr -s 5 ".kot[0:4]"  3 9 9 9 3;
createNode animCurveTA -n "brt_L_FK_Shoulder_rotateY";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 5 ".ktv[0:4]"  0 -26.429986382153416 4 -50.108700564022719 
		8 -23.221445597911824 12 -54.971728085802965 16 -26.429986382153416;
	setAttr -s 5 ".kit[0:4]"  3 9 9 9 3;
	setAttr -s 5 ".kot[0:4]"  3 9 9 9 3;
createNode animCurveTA -n "brt_L_FK_Shoulder_rotateZ";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 5 ".ktv[0:4]"  0 -80.507254060246169 4 45.517922044123083 
		8 79.23364089111989 12 34.150403373324956 16 -80.507254060246169;
	setAttr -s 5 ".kit[0:4]"  3 9 9 9 3;
	setAttr -s 5 ".kot[0:4]"  3 9 9 9 3;
createNode animCurveTA -n "brt_R_FK_Elbow_rotateZ";
	setAttr ".tan" 3;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  0 93.268364440021131 8 77.63184522671942 
		16 93.268364440021131;
createNode animCurveTA -n "brt_L_FK_Elbow_rotateZ";
	setAttr ".tan" 3;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  0 69.881584041628727 8 78.326804787598519 
		16 69.881584041628727;
createNode animCurveTA -n "brt_R_FK_Wrist_rotateX";
	setAttr ".tan" 3;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  2 2.1797668781161059 10 2.0610272985067195 
		18 2.1797668781161059;
	setAttr ".pre" 3;
	setAttr ".pst" 3;
createNode animCurveTA -n "brt_R_FK_Wrist_rotateY";
	setAttr ".tan" 3;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  2 20.399207593612854 10 -7.5805908010245737 
		18 20.399207593612854;
	setAttr ".pre" 3;
	setAttr ".pst" 3;
createNode animCurveTA -n "brt_R_FK_Wrist_rotateZ";
	setAttr ".tan" 3;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  2 36.329672702089795 10 -24.098963235229792 
		18 36.329672702089795;
	setAttr ".pre" 3;
	setAttr ".pst" 3;
createNode animCurveTA -n "brt_L_FK_Wrist_rotateX";
	setAttr ".tan" 3;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  2 17.579380079026755 10 4.0569758899581911 
		18 17.579380079026755;
createNode animCurveTA -n "brt_L_FK_Wrist_rotateY";
	setAttr ".tan" 3;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  2 -25.528122670452181 10 15.422846452098392 
		18 -25.528122670452181;
createNode animCurveTA -n "brt_L_FK_Wrist_rotateZ";
	setAttr ".tan" 3;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  2 -31.43693224140516 10 30.528481301135951 
		18 -31.43693224140516;
...
createNode animCurveTA -n "brt_Spine_2_rotateX";
	setAttr ".tan" 3;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  0 6.9720902296837517 8 -6.9720000000000004 
		16 6.9720902296837517;
	setAttr -s 3 ".kit[1:2]"  9 3;
	setAttr -s 3 ".kot[1:2]"  9 3;
createNode animCurveTA -n "brt_Spine_2_rotateY";
	setAttr ".tan" 3;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  0 -3.7066733255514928 8 3.707 16 
		-3.7066733255514928;
	setAttr -s 3 ".kit[1:2]"  9 3;
	setAttr -s 3 ".kot[1:2]"  9 3;
createNode animCurveTA -n "brt_Spine_2_rotateZ";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 2 ".ktv[0:1]"  0 14.369822450700433 16 14.369822450700433;
createNode animCurveTA -n "brt_Neck_rotateX";
	setAttr ".tan" 3;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  0 -10.812855433122161 8 18.639752169475752 
		16 -10.812855433122161;
...
createNode animCurveTA -n "brt_Neck_rotateZ";
	setAttr ".tan" 3;
	setAttr ".wgt" no;
	setAttr -s 2 ".ktv[0:1]"  8 -38.859228114321397 16 -38.859228114321397;
	setAttr -s 2 ".kit[1]"  9;
	setAttr -s 2 ".kot[1]"  9;
...
select -ne :hyperGraphLayout;
	...
	setAttr ".ims" 1;
select -ne :ikSystem;
connectAttr "brt_loco_dashSource.st" "clipLibrary1.st[0]";
connectAttr "brt_loco_dashSource.du" "clipLibrary1.du[0]";
