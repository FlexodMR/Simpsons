...
//Name: brt_stomp_slam_noy2.ma
//Last modified: Tue, May 27, 2003 01:55:13 PM
requires maya "4.0";
requires "p3dDeformer" "2.0";
requires "p3dmayaexp" "2.0.3.0";
requires "p3dSimpleShader" "2.0";
currentUnit -l meter -a degree -t ntsc;
createNode animClip -n "brt_stomp_slam_noy2Source";
	setAttr ".ihi" 0;
	setAttr ".du" 35;
	setAttr ".ci" no;
...
createNode animCurveTL -n "Right_Foot_Hoop_translateX";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 9 ".ktv[0:8]"  0 -0.063996940372714431 2 -0.22305166248886998 
		6 -0.13449352693114322 12 -0.16443011631103488 14 -0.095141685584289176 16 
		-0.13420738506930646 19 -0.13318763123013233 21 -0.20680453599946191 28 -0.20680453599946191;
	setAttr -s 9 ".kit[2:8]"  3 9 9 9 9 9 9;
	setAttr -s 9 ".kot[2:8]"  3 9 9 9 9 9 9;
createNode animCurveTL -n "Right_Foot_Hoop_translateY";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 12 ".ktv[0:11]"  0 1.2363063969441683 1 1.6143032404761815 
		2 1.2332684031504508 4 0.30802401568761251 6 0.55728625729309367 12 0.74966796425213023 
		14 -0.36153902675908328 16 1.1773509798447428 19 1.2539350414012767 21 0.43685116521245315 
		24 1.3775616625838913 28 0.18987362901403823;
	setAttr -s 12 ".kit[4:11]"  3 9 9 3 3 9 9 
		9;
	setAttr -s 12 ".kot[4:11]"  3 9 9 3 3 9 9 
		9;
createNode animCurveTL -n "Right_Foot_Hoop_translateZ";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 10 ".ktv[0:9]"  0 -0.39679809169350194 2 0.55941577653837427 
		6 -0.13269322163179165 12 0.25335423538279339 14 -0.55181367579641649 16 
		-0.47958209440089433 19 -0.35114826350538425 21 -0.2741480131556488 24 0.15566137513419304 
		28 -0.11771537289923364;
...
createNode animCurveTA -n "Right_Foot_Hoop_rotateX";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 13 ".ktv[0:12]"  0 -264.06173915683297 2 -87.386978752684627 
		3 -392.50520347066873 4 -388.52808454316209 6 -322.80520315478884 12 -339.65161680092802 
		16 -196.36526122009195 19 -169.16720554150803 21 -278.69605649788997 24 -397.51319294443999 
		28 -397.51319294443999 29 -363.1576645785301 35 -360;
	setAttr -s 13 ".kit[4:12]"  3 9 9 9 9 9 9 
		9 9;
	setAttr -s 13 ".kot[4:12]"  3 9 9 9 9 9 9 
		9 9;
createNode animCurveTA -n "Right_Foot_Hoop_rotateY";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  0 -25.948901905116401 4 -27.599931018877914 
		28 -25.948901905116401;
createNode animCurveTA -n "Right_Foot_Hoop_rotateZ";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  0 0 4 -0.43025554034807745 28 0;
createNode animCurveTL -n "Left_Foot_Hoop_translateX";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 12 ".ktv[0:11]"  0 0.3417113177903025 2 0.18265659567414649 
...
createNode animCurveTL -n "Left_Foot_Hoop_translateY";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 13 ".ktv[0:12]"  0 1.5556313753391608 1 1.8468633621557886 
		2 1.552593381545442 4 0.83380120884756226 6 0.76151261775862567 12 0.98661072937354333 
		16 1.0302073836034213 19 1.4041934063037069 21 0.56150690518035307 24 1.4555884906448611 
		28 0.19285174209233688 29 0.219 35 0.219;
	setAttr -s 13 ".kit[4:12]"  3 9 3 3 9 9 3 
		3 3;
	setAttr -s 13 ".kot[4:12]"  3 9 3 3 9 9 3 
		3 3;
createNode animCurveTL -n "Left_Foot_Hoop_translateZ";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 12 ".ktv[0:11]"  0 -0.32317597504448287 2 0.63303789318739345 
...
createNode animCurveTA -n "Left_Foot_Hoop_rotateX";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 13 ".ktv[0:12]"  0 -256.5433934961959 2 -79.868633092047673 
		3 -418.4996612147707 4 -394.16002757093759 6 -337.13515975756604 12 -285.03985885544677 
		16 -198.31595132614373 19 -163.68995775419228 21 -273.8468713246732 24 -395.78327963936084 
		28 -395.78327963936084 29 -360 35 -360;
	setAttr -s 13 ".kit[4:12]"  3 3 9 9 9 9 3 
		3 3;
	setAttr -s 13 ".kot[4:12]"  3 3 9 9 9 9 3 
		3 3;
...
createNode animCurveTL -n "Character_Hoop_translateY";
	setAttr ".tan" 3;
	setAttr ".wgt" no;
	setAttr -s 7 ".ktv[0:6]"  0 1.1795500880438168 6 1.1795500880438168 
		12 1.4026760789293835 19 0.75753835219190901 24 1.8753770000000001 29 0.6686478846148981 
		35 0.95500000000000007;
	setAttr -s 7 ".kit[3:6]"  9 9 1 3;
	setAttr -s 7 ".kot[3:6]"  1 9 3 3;
...
createNode animCurveTA -n "Character_Hoop_rotateX";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 9 ".ktv[0:8]"  0 127.24988139008805 3 313.82290964157448 
		6 354.92574384663027 12 342.43210796118399 16 455.46883430385896 19 467.42048935088877 
		25 381.58030123388176 29 361.76127084074756 35 359.37200000000001;
	setAttr -s 9 ".kit[2:8]"  3 3 9 3 9 3 9;
	setAttr -s 9 ".kot[2:8]"  3 3 9 3 9 3 9;
...
select -ne :hyperGraphLayout;
	...
	setAttr ".ims" 1;
select -ne :ikSystem;
connectAttr "brt_stomp_slam_noy2Source.st" "clipLibrary1.st[0]";
connectAttr "brt_stomp_slam_noy2Source.du" "clipLibrary1.du[0]";
