...
//Name: cpd_in_car_idle.ma
//Last modified: Thu, Aug 01, 2002 02:16:33 PM
requires maya "4.0";
...
createNode animClip -n "cpd_in_car_idleSource";
	setAttr ".ihi" 0;
	setAttr ".du" 60;
	setAttr ".ci" no;
...
select -ne :hyperGraphLayout;
	...
	setAttr ".ims" 1;
select -ne :ikSystem;
connectAttr "cpd_in_car_idleSource.st" "clipLibrary1.st[0]";
connectAttr "cpd_in_car_idleSource.du" "clipLibrary1.du[0]";
