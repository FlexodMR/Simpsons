...
//Name: cpd_flail.ma
//Last modified: Thu, Aug 01, 2002 01:56:53 PM
requires maya "4.0";
requires "p3dDeformer" "17.1.1.0";
requires "p3dmayaexp" "17.9.1.0";
requires "p3dSimpleShader" "17.1";
currentUnit -l meter -a degree -t ntsc;
createNode animClip -n "cpd_flailSource";
	setAttr ".ihi" 0;
	setAttr ".du" 16;
	setAttr ".ci" no;
...
createNode animCurveTL -n "animCurveTL54";
	...
	setAttr -s 17 ".ktv[0:16]"  0 0.48006904753831925 1 0.47698492283843585 
		...
		10 -0.48289174808881435 11 -0.36058570653758681 12 -0.17794871490870279 13 
		0.038698844497117461 14 0.25097141667385986 15 0.40480988763703596 16 0.48006904753831925;
...
createNode animCurveTA -n "animCurveTA277";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  0.245 170.81052382590363 6.245 
		170.81052382590363 12.245 170.81052382590363 16.245 170.81052382590363;
	setAttr ".pst" 3;
...
createNode animCurveTA -n "animCurveTA313";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  0 216.30151713929897 6 216.30151713929897 
		12 216.30151713929897 16 216.30151713929897;
	setAttr ".pst" 3;
createNode animCurveTA -n "animCurveTA314";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  0 27.585621117177766 6 27.585621117177766 
		12 27.585621117177766 16 27.585621117177766;
	setAttr ".pst" 3;
createNode animCurveTA -n "animCurveTA315";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  0 -6.1238845215508206 6 -6.1238845215508206 
		12 -6.1238845215508206 16 -6.1238845215508206;
	setAttr ".pst" 3;
...
select -ne :hyperGraphLayout;
	...
	setAttr ".ims" 1;
select -ne :ikSystem;
connectAttr "cpd_flailSource.st" "clipLibrary1.st[0]";
connectAttr "cpd_flailSource.du" "clipLibrary1.du[0]";
...
connectAttr "animCurveTA204.a" "clipLibrary1.cel[0].cev[23].cevr";
connectAttr "animCurveTA205.a" "clipLibrary1.cel[0].cev[24].cevr";
connectAttr "animCurveTA206.a" "clipLibrary1.cel[0].cev[25].cevr";
...
connectAttr "animCurveTA277.a" "clipLibrary1.cel[0].cev[126].cevr";
connectAttr "animCurveTA278.a" "clipLibrary1.cel[0].cev[127].cevr";
connectAttr "animCurveTA279.a" "clipLibrary1.cel[0].cev[128].cevr";
...
connectAttr "animCurveTA313.a" "clipLibrary1.cel[0].cev[162].cevr";
connectAttr "animCurveTA314.a" "clipLibrary1.cel[0].cev[163].cevr";
connectAttr "animCurveTA315.a" "clipLibrary1.cel[0].cev[164].cevr";
