...
//Name: lsa_stomp_all.ma
//Last modified: Thu, Jan 30, 2003 10:44:09 AM
requires maya "4.0";
requires "p3dmayaexp" "18.5";
requires "p3dSimpleShader" "18.5";
currentUnit -l meter -a degree -t ntsc;
createNode animClip -n "lsa_stomp_allSource";
	setAttr ".ihi" 0;
	setAttr ".du" 35;
	setAttr ".ci" no;
...
createNode animCurveTL -n "lsa_Left_Foot_Hoop_translateZ";
	...
	setAttr -s 5 ".ktv[0:4]"  0 1.4198122414469547 6 1.5638022491423764 
		13 1.5638022491423764 16 1.6717955709139822 21 1.2343609620178548;
...
createNode animCurveTL -n "lsa_Character_Hoop_translateY";
	...
	setAttr -s 8 ".ktv[0:7]"  0 5.6959663871383706 4 5.6707858306249026 
		7 0.98178372055760754 11 0.60185925676499186 14 1.3898225237613531 20 1.3898225237613531 
...
createNode animCurveTA -n "lsa_Thumb_R_rotateZ";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr ".ktv[0]"  35 8.3848495590963825;
...
select -ne :hyperGraphLayout;
	...
	setAttr ".ims" 1;
select -ne :ikSystem;
connectAttr "lsa_stomp_allSource.st" "clipLibrary1.st[0]";
connectAttr "lsa_stomp_allSource.du" "clipLibrary1.du[0]";
