...
//Name: lsa-m_get_into_car_open_door.ma
//Last modified: Wed, Jul 31, 2002 04:46:57 PM
requires maya "4.0";
requires "p3dSimpleShader" "18.0";
requires "p3dmayaexp" "18.0";
requires "WorldBuilder" "3.0";
currentUnit -l meter -a degree -t ntsc;
createNode animClip -n "lsa_get_into_car_open_door";
	setAttr ".ihi" 0;
	setAttr ".du" 14;
	setAttr ".ci" no;
...
createNode animCurveTL -n "animCurveTL454";
	...
	setAttr -s 15 ".ktv[0:14]"  0 0.033135114381557439 1 0.035667470030465831 
		...
		13 0.038155953308526551 14 0.033135114381557439;
...
select -ne :hyperGraphLayout;
	...
	setAttr ".ims" 1;
select -ne :ikSystem;
connectAttr "lsa_get_into_car_open_door.st" "clipLibrary2.st[0]";
connectAttr "lsa_get_into_car_open_door.du" "clipLibrary2.du[0]";
...
// End of lsa-m_get_into_car_open_door.ma
