...
//Name: lsa_get_into_car_all_driver.ma
//Last modified: Fri, Oct 11, 2002 02:54:59 PM
requires maya "4.0";
requires "p3dmayaexp" "18.6";
requires "p3dSimpleShader" "18.6";
requires "WorldBuilder" "3.0";
currentUnit -l meter -a degree -t ntsc;
createNode animClip -n "lsa_get_into_car_all_driverSource";
	setAttr ".ihi" 0;
	setAttr ".du" 44;
	setAttr ".ci" no;
...
select -ne :hyperGraphLayout;
	...
	setAttr ".ims" 1;
select -ne :ikSystem;
connectAttr "lsa_get_into_car_all_driverSource.st" "clipLibrary1.st[0]";
connectAttr "lsa_get_into_car_all_driverSource.du" "clipLibrary1.du[0]";
...
// End of lsa_get_into_car_all_driver.ma
