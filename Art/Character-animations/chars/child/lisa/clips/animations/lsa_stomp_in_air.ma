...
//Name: lsa_stomp_in_air.ma
//Last modified: Thu, Jan 30, 2003 10:44:25 AM
requires maya "4.0";
requires "p3dmayaexp" "18.5";
requires "p3dSimpleShader" "18.5";
currentUnit -l meter -a degree -t ntsc;
createNode animClip -n "lsa_stomp_in_airSource";
	setAttr ".ihi" 0;
	setAttr ".du" 7;
	setAttr ".ci" no;
...
createNode animCurveTA -n "Right_Foot_Hoop_rotateX";
	...
	setAttr -s 8 ".ktv[0:7]"  0 -26.37374737372533 1 -25.749154135927615 
		2 -25.033157014798849 3 -24.317159896510788 4 -23.692566667235212 5 -23.250781213143913 
...
createNode animCurveTA -n "Right_Foot_Hoop_rotateY";
	...
	setAttr -s 8 ".ktv[0:7]"  0 -6.6356540421061805 1 -2.5899729705336485 
		2 2.0477590340298084 3 6.6854910632310025 4 10.731172208716751 5 13.592751562133879 
...
createNode animCurveTL -n "Left_Foot_Hoop_translateZ";
	...
	setAttr -s 8 ".ktv[0:7]"  0 1.4198122414469547 1 1.4471436784422003 
		2 1.4784748376218939 3 1.5098059966338973 4 1.5371374331260705 5 1.5564694247462769 
...
createNode animCurveTA -n "Left_Foot_Hoop_rotateX";
	...
	setAttr -s 8 ".ktv[0:7]"  0 -17.935675747740234 1 -13.926582031006939 
		2 -9.3307917569807586 3 -4.7350015295949968 4 -0.72590795278297793 5 2.1097923695219949 
...
createNode animCurveTA -n "Left_Foot_Hoop_rotateY";
	...
	setAttr -s 8 ".ktv[0:7]"  0 -4.6947134066376632 1 -6.300019393907565 
		...
		6 -13.151935453658673 7 -13.151935453658673;
...
createNode animCurveTA -n "lsa_Thumb_R_rotateZ";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr ".ktv[0]"  7 8.3848495590963825;
...
select -ne :hyperGraphLayout;
	...
	setAttr ".ims" 1;
select -ne :ikSystem;
connectAttr "lsa_stomp_in_airSource.st" "clipLibrary1.st[0]";
connectAttr "lsa_stomp_in_airSource.du" "clipLibrary1.du[0]";
