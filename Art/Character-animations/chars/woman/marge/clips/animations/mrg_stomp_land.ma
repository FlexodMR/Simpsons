...
//Name: mrg_stomp_land.ma
//Last modified: Thu, Jan 30, 2003 11:36:26 AM
requires maya "4.0";
requires "p3dmayaexp" "18.5";
requires "p3dSimpleShader" "18.5";
currentUnit -l meter -a degree -t ntsc;
createNode animClip -n "mrg_stomp_landSource";
	setAttr ".ihi" 0;
	setAttr ".du" 23;
	setAttr ".ci" no;
...
select -ne :hyperGraphLayout;
	...
	setAttr ".ims" 1;
select -ne :ikSystem;
connectAttr "mrg_stomp_landSource.st" "clipLibrary1.st[0]";
connectAttr "mrg_stomp_landSource.du" "clipLibrary1.du[0]";
