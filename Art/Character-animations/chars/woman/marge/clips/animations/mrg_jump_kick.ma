...
//Name: mrg_jump_kick.ma
//Last modified: Thu, Jan 30, 2003 11:36:05 AM
requires maya "4.0";
requires "p3dmayaexp" "18.5";
requires "p3dSimpleShader" "18.5";
currentUnit -l meter -a degree -t ntsc;
createNode animClip -n "mrg_jump_kickSource";
	setAttr ".ihi" 0;
	setAttr ".du" 13;
	setAttr ".ci" no;
...
select -ne :hyperGraphLayout;
	...
	setAttr ".ims" 1;
select -ne :ikSystem;
connectAttr "mrg_jump_kickSource.st" "clipLibrary1.st[0]";
connectAttr "mrg_jump_kickSource.du" "clipLibrary1.du[0]";
