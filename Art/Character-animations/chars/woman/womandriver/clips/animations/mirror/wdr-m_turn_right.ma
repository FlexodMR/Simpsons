...
//Name: wdr-m_turn_right.ma
//Last modified: Mon, Aug 12, 2002 01:47:29 PM
requires maya "4.0";
...
select -ne :ikSystem;
	setAttr -s 3 ".sol";
connectAttr "wdr_turn_right.st" "clipLibrary3.st[0]";
connectAttr "wdr_turn_right.du" "clipLibrary3.du[0]";
...
connectAttr "wdr_turn_right.st" "clipLibrary4.st[0]";
connectAttr "wdr_turn_right.du" "clipLibrary4.du[0]";
