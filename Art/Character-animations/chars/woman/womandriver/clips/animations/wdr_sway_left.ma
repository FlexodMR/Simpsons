...
//Name: wdr_sway_left.ma
//Last modified: Mon, Aug 12, 2002 01:51:47 PM
requires maya "4.0";
requires "p3dSimpleShader" "18.0";
requires "p3dmayaexp" "18.0";
requires "WorldBuilder" "3.0";
currentUnit -l meter -a degree -t ntsc;
createNode animClip -n "wdr_sway_leftSource";
	setAttr ".ihi" 0;
	setAttr ".du" 30;
	setAttr ".ci" no;
...
select -ne :hyperGraphLayout;
	...
	setAttr ".ims" 1;
select -ne :ikSystem;
connectAttr "wdr_sway_leftSource.st" "clipLibrary1.st[0]";
connectAttr "wdr_sway_leftSource.du" "clipLibrary1.du[0]";
