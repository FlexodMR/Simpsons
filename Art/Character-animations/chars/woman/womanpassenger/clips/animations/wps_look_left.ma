...
//Name: wps_look_left.ma
//Last modified: Wed, Aug 14, 2002 11:29:02 AM
requires maya "4.0";
requires "p3dmayaexp" "18.2";
requires "p3dSimpleShader" "18.0";
requires "WorldBuilder" "3.0";
currentUnit -l meter -a degree -t ntsc;
createNode animClip -n "wps_look_leftSource";
	setAttr ".ihi" 0;
	setAttr ".du" 32;
	setAttr ".ci" no;
...
createNode animCurveTL -n "Right_Arm_Hoop_translateX";
	...
	setAttr -s 33 ".ktv[0:32]"  0 -0.16261187792304868 1 -0.22404042581814396 
		...
		10 -0.38885753769467812 11 -0.43687894772991059 12 -0.51884341674229773 13 
		-0.60248554325396897 14 -0.65171516673263452 15 -0.67095938133726007 16 -0.68715984858054413 
		17 -0.69981533799481788 18 -0.70846066836474142 19 -0.71265396134990933 20 
		-0.71196539111671575 21 -0.70596745120061055 22 -0.69422674088590752 23 -0.67629725746952096 
		24 -0.65171516673263452 25 -0.6164557963061571 26 -0.56836788718512221 27 
		-0.50970863392036136 28 -0.44301041010841713 29 -0.37132239704015746 30 -0.29818230619250785 
		31 -0.22737766899176307 32 -0.16261187792304868;
createNode animCurveTL -n "Right_Arm_Hoop_translateY";
	...
	setAttr -s 33 ".ktv[0:32]"  0 -0.83267844404058533 1 -0.83657433876743437 
		...
		6 -0.86813546589401147 7 -0.87273824487409013 8 -0.87372672796737183 9 -0.86913490466782939 
...
createNode animCurveTA -n "Right_Arm_Hoop_rotateY";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 33 ".ktv[0:32]"  0 45.790364280405264 1 39.716868391288052 
		...
		26 24.763884544377994 27 27.149651662411038 28 30.476301848801533 29 34.415173653510351 
...
createNode animCurveTL -n "Left_Arm_Hoop_translateX";
	...
	setAttr -s 33 ".ktv[0:32]"  0 0.20793334527655816 1 0.23687816933339834 
		...
		10 0.31762066750407542 11 0.3040111161322494 12 0.27551808944673212 13 0.23995963551020283 
		14 0.22050110704120698 15 0.21964935449164158 16 0.21923847583723557 17 0.21916330410958096 
		18 0.21932914676367204 19 0.21964758290502345 20 0.22003306334633066 21 0.22040021395402051 
		22 0.22066176706456986 23 0.22072706633348729 24 0.22050110704120698 25 0.2217988317477301 
		26 0.22523219122394098 27 0.22874469484489679 28 0.23050775007436244 29 0.22930560911480086 
		30 0.22473362127302324 31 0.21722455297046167 32 0.20793334527655816;
...
createNode animCurveTA -n "Left_Arm_Hoop_rotateX";
	...
	setAttr -s 33 ".ktv[0:32]"  0 31.546913396341154 1 31.196437113440592 
		...
		6 26.677094861472664 7 24.417820575057227 8 23.558976841509107 9 25.202596596097077 
		10 30.140858128714566 11 43.161230478783132 12 62.573035449938978 13 89.541851192043069 
...
createNode animCurveTA -n "Left_Arm_Hoop_rotateZ";
	...
	setAttr -s 33 ".ktv[0:32]"  0 -82.514492469619711 1 -80.043062848388686 
		...
		6 -71.612476395501616 7 -71.541929662368247 8 -71.936667759775659 9 -72.588725939628134 
		10 -72.874867028492147 11 -71.825231052603129 12 -69.889483601242304 13 -79.822636532350771 
		14 -105.13363855517605 15 -117.38626879528432 16 -127.86279639704233 17 -134.53324778646783 
		18 -137.5448764520919 19 -137.65175739748491 20 -135.40668438831841 21 -131.0403704782004 
		22 -124.54611859923692 23 -115.85209320497022 24 -105.13363855517605 25 -90.018513313906638 
		26 -73.7227845091668 27 -63.602718289241764 28 -60.35975733611405 29 -62.097536733845622 
		30 -67.189134427466911 31 -74.379742527490905 32 -82.514492469619711;
...
createNode animCurveTL -n "animCurveTL77";
	...
	setAttr -s 6 ".ktv[0:5]"  0 0.22996541113775407 4 0.35039089098226439 
		10 0.35039089098226439 14 1.0573987569190908 24 1.0573987569190908 32 0.22996541113775407;
	setAttr -s 6 ".kit[0:5]"  1 9 9 9 9 9;
...
createNode animCurveTL -n "animCurveTL80";
	...
	setAttr -s 6 ".ktv[0:5]"  0 -0.017571725225418906 4 -0.26092998218534857 
		10 -0.26092998218534857 14 -0.1599581978586076 24 -0.1599581978586076 32 
...
createNode animCurveTA -n "animCurveTA183";
	...
	setAttr -s 6 ".ktv[0:5]"  0 8.5572674112203639 4 8.5572674112203622 
		10 8.5572674112203622 14 8.5572674112203622 24 8.5572674112203622 32 8.5572674112203639;
	setAttr -s 6 ".kit[0:5]"  1 9 9 9 9 9;
	setAttr -s 6 ".kix[0:5]"  0 1 1 1 1 1;
	setAttr -s 6 ".kiy[0:5]"  0 0 0 0 0 0;
...
createNode animCurveTA -n "animCurveTA221";
	...
	setAttr -s 6 ".kox[3:5]"  0.99904364347457886 0.99990206956863403 
		0.83101564645767212;
	setAttr -s 6 ".koy[3:5]"  0.043724525719881058 0.013996396213769913 
		-0.55624902248382568;
...
select -ne :hyperGraphLayout;
	...
	setAttr ".ims" 1;
select -ne :ikSystem;
connectAttr "wps_look_leftSource.st" "clipLibrary1.st[0]";
connectAttr "wps_look_leftSource.du" "clipLibrary1.du[0]";
...
connectAttr "animCurveTA130.a" "clipLibrary1.cel[0].cev[38].cevr";
connectAttr "animCurveTA131.a" "clipLibrary1.cel[0].cev[39].cevr";
connectAttr "animCurveTA132.a" "clipLibrary1.cel[0].cev[40].cevr";
connectAttr "animCurveTA133.a" "clipLibrary1.cel[0].cev[41].cevr";
connectAttr "animCurveTA134.a" "clipLibrary1.cel[0].cev[42].cevr";
connectAttr "animCurveTA135.a" "clipLibrary1.cel[0].cev[43].cevr";
...
connectAttr "animCurveTA159.a" "clipLibrary1.cel[0].cev[76].cevr";
connectAttr "animCurveTA160.a" "clipLibrary1.cel[0].cev[77].cevr";
connectAttr "animCurveTA161.a" "clipLibrary1.cel[0].cev[78].cevr";
connectAttr "animCurveTA162.a" "clipLibrary1.cel[0].cev[79].cevr";
connectAttr "animCurveTA163.a" "clipLibrary1.cel[0].cev[80].cevr";
connectAttr "animCurveTA164.a" "clipLibrary1.cel[0].cev[81].cevr";
...
connectAttr "animCurveTA171.a" "clipLibrary1.cel[0].cev[97].cevr";
connectAttr "animCurveTA172.a" "clipLibrary1.cel[0].cev[98].cevr";
connectAttr "animCurveTA173.a" "clipLibrary1.cel[0].cev[99].cevr";
...
connectAttr "animCurveTA174.a" "clipLibrary1.cel[0].cev[103].cevr";
connectAttr "animCurveTA175.a" "clipLibrary1.cel[0].cev[104].cevr";
connectAttr "animCurveTA176.a" "clipLibrary1.cel[0].cev[105].cevr";
...
connectAttr "animCurveTA227.a" "clipLibrary1.cel[0].cev[162].cevr";
connectAttr "animCurveTA228.a" "clipLibrary1.cel[0].cev[163].cevr";
connectAttr "animCurveTA229.a" "clipLibrary1.cel[0].cev[164].cevr";
connectAttr "animCurveTA230.a" "clipLibrary1.cel[0].cev[165].cevr";
connectAttr "animCurveTA231.a" "clipLibrary1.cel[0].cev[166].cevr";
connectAttr "animCurveTA232.a" "clipLibrary1.cel[0].cev[167].cevr";
