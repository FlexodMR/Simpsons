...
//Name: gpa_bump_into_person.ma
//Last modified: Tue, Aug 13, 2002 10:21:21 AM
requires maya "4.0";
requires "p3dSimpleShader" "18.0";
currentUnit -l meter -a degree -t film;
createNode animClip -n "gpa_bump_into_personSource";
	setAttr ".ihi" 0;
	setAttr ".du" 23;
	setAttr ".ci" no;
...
select -ne :hyperGraphLayout;
	...
	setAttr ".ims" 1;
select -ne :ikSystem;
connectAttr "gpa_bump_into_personSource.st" "clipLibrary1.st[0]";
connectAttr "gpa_bump_into_personSource.du" "clipLibrary1.du[0]";
...
// End of gpa_bump_into_person.ma
