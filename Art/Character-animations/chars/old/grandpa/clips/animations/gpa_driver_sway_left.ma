...
//Name: gpa_driver_sway_left.ma
//Last modified: Tue, Aug 13, 2002 10:23:33 AM
requires maya "4.0";
requires "p3dmayaexp" "18.2";
requires "p3dSimpleShader" "18.0";
requires "WorldBuilder" "3.0";
currentUnit -l meter -a degree -t ntsc;
createNode animClip -n "gpa_driver_sway_leftSource";
	setAttr ".ihi" 0;
	setAttr ".du" 30;
	setAttr ".ci" no;
...
select -ne :hyperGraphLayout;
	...
	setAttr ".ims" 1;
select -ne :ikSystem;
connectAttr "gpa_driver_sway_leftSource.st" "clipLibrary2.st[0]";
connectAttr "gpa_driver_sway_leftSource.du" "clipLibrary2.du[0]";
...
// End of gpa_driver_sway_left.ma
