...
//Name: odr_wave_goodbye.ma
//Last modified: Tue, Aug 13, 2002 05:14:13 PM
requires maya "4.0";
requires "p3dmayaexp" "18.2";
requires "p3dSimpleShader" "18.0";
requires "WorldBuilder" "3.0";
currentUnit -l meter -a degree -t ntsc;
createNode animClip -n "odr_wave_goodbyeSource";
	setAttr ".ihi" 0;
	setAttr ".du" 35;
	setAttr ".ci" no;
...
createNode animCurveTL -n "Motion_Root_translateZ";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 36 ".ktv[0:35]"  0 0.97616451601631116 1 0.97616451601631116 
		...
		34 0.97616451601631116 35 0.97616451601631116;
...
select -ne :hyperGraphLayout;
	...
	setAttr ".ims" 1;
select -ne :ikSystem;
connectAttr "odr_wave_goodbyeSource.st" "clipLibrary2.st[0]";
connectAttr "odr_wave_goodbyeSource.du" "clipLibrary2.du[0]";
