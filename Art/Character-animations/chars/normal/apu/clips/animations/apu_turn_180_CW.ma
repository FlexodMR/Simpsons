...
//Name: apu_turn_180_CW.ma
//Last modified: Thu, Jun 13, 2002 12:20:56 PM
requires maya "4.0";
requires "p3dmayaexp" "17.3";
requires "p3dSimpleShader" "17.1";
currentUnit -l meter -a degree -t ntsc;
createNode animClip -n "apu_turn_180_CWSource";
	setAttr ".ihi" 0;
	setAttr ".du" 35;
	setAttr ".ci" no;
...
createNode animCurveTA -n "animCurveTA119";
	...
	setAttr -s 9 ".ktv[0:8]"  0 0 4 -89.90525235120468 6 -139.35158516901186 
		...
		33 -177.98216460415622 35 -179.24654672876324;
	setAttr -s 9 ".kit[4:8]"  3 3 3 9 9;
	setAttr -s 9 ".kot[4:8]"  3 3 3 9 9;
...
createNode animCurveTL -n "animCurveTL63";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 9 ".ktv[0:8]"  0 0.95976092787099887 4 0.94516162831462047 
...
createNode animCurveTA -n "animCurveTA130";
	...
	setAttr -s 9 ".ktv[0:8]"  0 10.244833886622574 4 25.830531440809363 
		6 18.46438489041708 8 6.6271967526040259 12 -13.555438057352168 27 -13.555438057352168 
...
createNode animCurveTA -n "animCurveTA155";
	...
	setAttr -s 9 ".ktv[0:8]"  0 0.0034456079181433771 4 0.0034456079181433771 
		...
		27 0.0034456079181433771 31 0.0034456079181433771 33 -27.186769571036269 
		35 -27.186769571036269;
...
createNode animCurveTA -n "animCurveTA176";
	...
	setAttr -s 15 ".ktv[0:14]"  0 60.585329838143075 4 60.585329838143075 
		...
		16 -43.674682310454642 18 29.284068499817948 20 53.489694886273064 22 -15.719086348395356 
...
createNode animCurveTA -n "animCurveTA210";
	...
	setAttr -s 9 ".ktv[0:8]"  0 -2.3998587564717182 4 -2.3998587564717182 
		6 -1.6934676833787039 8 -0.84819942876019017 12 0.26281804566783512 27 0.26281804566783512 
...
createNode animCurveTA -n "animCurveTA215";
	...
	setAttr -s 9 ".ktv[0:8]"  0 3.0573637994901306 4 3.0701159580853066 
		6 3.1927292020775928 8 3.1333207555380378 12 1.6898993192373 27 1.6898993192373 
...
createNode animCurveTA -n "animCurveTA217";
	...
	setAttr -s 9 ".ktv[0:8]"  0 3.2883345540401034 4 4.2980269842767287 
		6 10.264215348862134 8 11.522128031251736 12 -25.134386054034699 27 -25.134386054034699 
...
select -ne :hyperGraphLayout;
	...
	setAttr ".ims" 1;
select -ne :ikSystem;
connectAttr "apu_turn_180_CWSource.st" "clipLibrary1.st[0]";
connectAttr "apu_turn_180_CWSource.du" "clipLibrary1.du[0]";
