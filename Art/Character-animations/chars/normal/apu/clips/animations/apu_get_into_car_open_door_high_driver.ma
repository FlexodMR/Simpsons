...
//Name: apu_get_into_car_open_door_high_driver.ma
//Last modified: Wed, Oct 09, 2002 02:43:12 PM
requires maya "4.0";
requires "p3dmayaexp" "18.6";
requires "p3dSimpleShader" "18.6";
requires "WorldBuilder" "3.0";
currentUnit -l meter -a degree -t ntsc;
createNode animClip -n "apu_get_into_car_open_door_high_driverSource";
	setAttr ".ihi" 0;
	setAttr ".du" 14;
	setAttr ".ci" no;
...
select -ne :hyperGraphLayout;
	...
	setAttr ".ims" 1;
select -ne :ikSystem;
connectAttr "apu_get_into_car_open_door_high_driverSource.st" "clipLibrary1.st[0]"
		;
connectAttr "apu_get_into_car_open_door_high_driverSource.du" "clipLibrary1.du[0]"
		;
...
// End of apu_get_into_car_open_door_high_driver.ma
