...
//Name: apu_surf_in.ma
//Last modified: Tue, Mar 04, 2003 11:47:31 AM
requires maya "4.0";
requires "p3dmayaexp" "2.0";
requires "p3dSimpleShader" "2.0";
currentUnit -l meter -a degree -t ntsc;
createNode animClip -n "apu_surf_inSource";
	setAttr ".ihi" 0;
	setAttr ".du" 4;
	setAttr ".ci" no;
...
select -ne :hyperGraphLayout;
	...
	setAttr ".ims" 1;
select -ne :ikSystem;
connectAttr "apu_surf_inSource.st" "clipLibrary2.st[0]";
connectAttr "apu_surf_inSource.du" "clipLibrary2.du[0]";
