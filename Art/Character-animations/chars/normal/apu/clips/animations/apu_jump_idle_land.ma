...
//Name: apu_jump_idle_land.ma
//Last modified: Wed, Oct 09, 2002 02:47:50 PM
requires maya "4.0";
requires "p3dmayaexp" "18.6";
requires "p3dSimpleShader" "18.6";
currentUnit -l meter -a degree -t ntsc;
createNode animClip -n "apu_jump_idle_landSource";
	setAttr ".ihi" 0;
	setAttr ".st" 29;
	setAttr ".du" 6;
	setAttr ".ci" no;
...
createNode animCurveTL -n "apu_Motion_Root_translateX";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  0 -0.054075435230564878 14 -0.054075435230564878 
		27 0.017070705143967826 35 -0.054075435230564878;
createNode animCurveTL -n "apu_Motion_Root_translateY";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  0 0 14 0 27 0 35 0;
createNode animCurveTL -n "apu_Motion_Root_translateZ";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  0 0 14 0 27 0.037596839027987924 
		35 0;
...
createNode animCurveTL -n "apu_Right_Foot_Hoop_translateX";
	...
	setAttr -s 10 ".ktv[0:9]"  0 -0.26454016861507795 5 -0.26454016861507795 
		10 -0.26454016861507795 12 -0.26454016861507795 14 -0.26454016861507795 21 
		-0.26454016861507795 27 -0.18973244063939956 29 -0.26454016861507795 31 -0.26454016861507795 
...
createNode animCurveTL -n "apu_Right_Foot_Hoop_translateY";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 10 ".ktv[0:9]"  0 0.13806192026723146 5 0.13806192026723146 
		10 0.13806192026723146 12 0.13806192026723146 14 0.25710544483843112 21 2.1092674111994238 
		27 0.54938577409474854 29 0.13806192026723146 31 0.13806192026723146 35 0.13806192026723146;
	setAttr -s 10 ".kit[2:9]"  3 3 1 9 9 3 3 
		9;
	setAttr -s 10 ".kot[2:9]"  3 1 1 9 9 3 3 
		9;
	setAttr -s 10 ".ktl[3:9]" no no yes yes yes yes yes;
	setAttr -s 10 ".kix[4:9]"  0.0039651021361351013 0.014824319630861282 
		0.0013528087874874473 1 1 1;
	setAttr -s 10 ".kiy[4:9]"  0.99999213218688965 0.99989008903503418 
		-0.99999910593032837 0 0 0;
	setAttr -s 10 ".kox[3:9]"  0.0076155457645654678 0.0013879647012799978 
		0.014824319630861282 0.0013528087874874473 1 1 1;
	setAttr -s 10 ".koy[3:9]"  0.99997097253799438 0.99999904632568359 
		0.99989008903503418 -0.99999910593032837 0 0 0;
createNode animCurveTL -n "apu_Right_Foot_Hoop_translateZ";
	...
	setAttr -s 10 ".ktv[0:9]"  0 -0.064904406754016042 5 -0.064904406754016042 
		10 -0.064904406754016042 12 -0.064904406754016042 14 0.03713290002129839 
		21 0.03713290002129839 27 0.03713290002129839 29 -0.064904406754016042 31 
		-0.064904406754016042 35 -0.064904406754016042;
	setAttr -s 10 ".kit[2:9]"  3 3 9 9 9 3 9 
		3;
	setAttr -s 10 ".kot[2:9]"  3 3 9 9 9 3 9 
		3;
...
createNode animCurveTL -n "apu_Left_Foot_Hoop_translateX";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 10 ".ktv[0:9]"  0 0.21594587158542247 5 0.21594587158542247 
		10 0.21594587158542247 12 0.21594587158542247 14 0.21594587158542247 21 0.21594587158542247 
		27 0.2576251586399893 29 0.21594587158542247 31 0.21594587158542247 35 0.21594587158542247;
	setAttr -s 10 ".kit[2:9]"  3 3 9 9 9 3 9 
		3;
	setAttr -s 10 ".kot[2:9]"  3 3 9 9 9 3 9 
		3;
createNode animCurveTL -n "apu_Left_Foot_Hoop_translateY";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 10 ".ktv[0:9]"  0 0.1380615615975922 5 0.1380615615975922 
		10 0.1380615615975922 12 0.1380615615975922 14 0.27244968875639058 21 2.257642995388895 
		27 0.19726414327757355 29 0.1380615615975922 31 0.1380615615975922 35 0.1380615615975922;
	setAttr -s 10 ".kit[2:9]"  3 3 1 9 9 3 3 
		9;
	setAttr -s 10 ".kot[2:9]"  3 1 9 9 1 3 3 
		9;
	setAttr -s 10 ".ktl[3:9]" no no yes no yes yes yes;
	setAttr -s 10 ".kix[4:9]"  0.0038938084617257118 0.057539697736501694 
		0.0012581091141328216 1 1 1;
	setAttr -s 10 ".kiy[4:9]"  0.99999243021011353 -0.99834322929382324 
		-0.99999922513961792 0 0 0;
	setAttr -s 10 ".kox[3:9]"  0.0074560628272593021 0.0014153723604977131 
		0.057539697736501694 0.0057429093867540359 1 1 1;
	setAttr -s 10 ".koy[3:9]"  0.99997222423553467 0.99999898672103882 
		-0.99834322929382324 -0.99998348951339722 0 0 0;
createNode animCurveTL -n "apu_Left_Foot_Hoop_translateZ";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 10 ".ktv[0:9]"  0 0.00078430246903575811 5 0.00078430246903575811 
		10 0.00078430246903575811 12 0.00078430246903575811 14 0.065531364856165897 
		21 0.065531364856165897 27 -0.0056281193528018086 29 0.00078430246903575811 
		31 0.00078430246903575811 35 0.00078430246903575811;
	setAttr -s 10 ".kit[2:9]"  3 3 9 9 9 3 9 
		3;
	setAttr -s 10 ".kot[2:9]"  3 3 9 9 9 3 9 
		3;
...
createNode animCurveTL -n "apu_Character_Hoop_translateX";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 10 ".ktv[0:9]"  0 -0.076472881617957691 5 -0.076472881617957691 
		10 -0.076472881617957691 12 -0.076472881617957691 14 -0.076472881617957691 
		21 -0.076472881617957691 27 0.024141202156646537 29 -0.076472881617957691 
		31 -0.076472881617957691 35 -0.076472881617957691;
createNode animCurveTL -n "apu_Character_Hoop_translateY";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 10 ".ktv[0:9]"  0 0.99296149630440855 5 0.75486637004729717 
		10 0.66976801659722129 12 0.71100335937226877 14 1.1272118668250493 21 2.8085482201082947 
		27 1.0655303176938011 29 0.66877609235387681 31 0.66877609235387681 35 0.99296149630440855;
createNode animCurveTL -n "apu_Character_Hoop_translateZ";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 10 ".ktv[0:9]"  0 0 5 0.0062740898459916067 10 
		-0.035192415435050035 12 0.05316903336862331 14 0.05316903336862331 21 0.05316903336862331 
		27 0.05316903336862331 29 0.079374105280250601 31 0.079374105280250601 35 
		0;
...
select -ne :hyperGraphLayout;
	...
	setAttr ".ims" 1;
select -ne :ikSystem;
connectAttr "apu_jump_idle_landSource.st" "clipLibrary1.st[0]";
connectAttr "apu_jump_idle_landSource.du" "clipLibrary1.du[0]";
