...
//Name: apu_get_out_of_car_driver.ma
//Last modified: Mon, Jan 13, 2003 11:02:09 AM
requires maya "4.0";
requires "p3dmayaexp" "2.0";
requires "p3dSimpleShader" "2.0";
requires "WorldBuilder" "3.0";
currentUnit -l meter -a degree -t ntsc;
createNode animClip -n "apu_get_out_of_car_driverSource";
	setAttr ".ihi" 0;
	setAttr ".st" 15;
	setAttr ".du" 15;
	setAttr ".ci" no;
...
createNode animCurveTL -n "animCurveTL87";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 16 ".ktv[0:15]"  15 0.66397436907633778 16 0.66913873766053844 
		17 0.67774601863420614 18 0.67946747482893965 19 0.66397436907633778 20 0.61826564245253157 
		21 0.55126553200772177 22 0.48553324453461183 23 0.44362798682590543 24 0.44798339226579309 
		25 0.48132954267993677 26 0.50667031752324609 27 0.51163123767509489 28 0.51089339105198006 
		29 0.50804400766449809 30 0.50667031752324609;
	setAttr -s 16 ".kit[15]"  1;
	setAttr -s 16 ".kot[0:15]"  1 9 9 9 9 9 9 
		9 9 9 9 9 9 9 9 9;
...
select -ne :hyperGraphLayout;
	...
	setAttr ".ims" 1;
select -ne :ikSystem;
connectAttr "apu_get_out_of_car_driverSource.st" "clipLibrary1.st[0]";
connectAttr "apu_get_out_of_car_driverSource.du" "clipLibrary1.du[0]";
...
// End of apu_get_out_of_car_driver.ma
