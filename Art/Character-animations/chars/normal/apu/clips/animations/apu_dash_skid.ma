...
//Name: apu_dash_skid.ma
//Last modified: Wed, Oct 09, 2002 02:40:55 PM
requires maya "4.0";
requires "p3dmayaexp" "18.6";
requires "p3dSimpleShader" "18.6";
currentUnit -l meter -a degree -t ntsc;
createNode animClip -n "apu_dash_skidSource";
	setAttr ".ihi" 0;
	setAttr ".st" 16;
	setAttr ".du" 17;
	setAttr ".ci" no;
...
select -ne :hyperGraphLayout;
	...
	setAttr ".ims" 1;
select -ne :ikSystem;
connectAttr "apu_dash_skidSource.st" "clipLibrary1.st[0]";
connectAttr "apu_dash_skidSource.du" "clipLibrary1.du[0]";
