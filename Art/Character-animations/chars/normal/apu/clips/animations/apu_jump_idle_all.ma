...
//Name: apu_jump_idle_all.ma
//Last modified: Wed, Oct 09, 2002 02:47:30 PM
requires maya "4.0";
requires "p3dmayaexp" "18.6";
requires "p3dSimpleShader" "18.6";
currentUnit -l meter -a degree -t ntsc;
createNode animClip -n "apu_jump_idle_allSource";
	setAttr ".ihi" 0;
	setAttr ".du" 35;
	setAttr ".ci" no;
...
createNode animCurveTL -n "apu_Motion_Root_translateX";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 2 ".ktv[0:1]"  0 -0.054075435230564878 35 -0.054075435230564878;
...
select -ne :hyperGraphLayout;
	...
	setAttr ".ims" 1;
select -ne :ikSystem;
connectAttr "apu_jump_idle_allSource.st" "clipLibrary1.st[0]";
connectAttr "apu_jump_idle_allSource.du" "clipLibrary1.du[0]";
