...
//Name: apu_phone_put_down.ma
//Last modified: Wed, Oct 09, 2002 02:50:21 PM
requires maya "4.0";
requires "p3dDeformer" "18.3";
requires "p3dmayaexp" "18.6";
requires "p3dSimpleShader" "18.6";
currentUnit -l meter -a degree -t ntsc;
createNode animClip -n "apu_phone_put_downSource";
	setAttr ".ihi" 0;
	setAttr ".st" 42;
	setAttr ".du" 18;
	setAttr ".ci" no;
...
select -ne :hyperGraphLayout;
	...
	setAttr ".ims" 1;
select -ne :ikSystem;
connectAttr "apu_phone_put_downSource.st" "clipLibrary1.st[0]";
connectAttr "apu_phone_put_downSource.du" "clipLibrary1.du[0]";
