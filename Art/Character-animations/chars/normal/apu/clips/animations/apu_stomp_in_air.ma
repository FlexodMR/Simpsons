...
//Name: apu_stomp_in_air.ma
//Last modified: Thu, Jan 30, 2003 11:46:51 AM
requires maya "4.0";
requires "p3dmayaexp" "18.5";
requires "p3dSimpleShader" "18.5";
currentUnit -l meter -a degree -t ntsc;
createNode animClip -n "apu_stomp_in_airSource";
	setAttr ".ihi" 0;
	setAttr ".du" 7;
	setAttr ".ci" no;
...
select -ne :hyperGraphLayout;
	...
	setAttr ".ims" 1;
select -ne :ikSystem;
connectAttr "apu_stomp_in_airSource.st" "clipLibrary1.st[0]";
connectAttr "apu_stomp_in_airSource.du" "clipLibrary1.du[0]";
