...
//Name: apu_jump_idle_take_off.ma
//Last modified: Wed, Oct 09, 2002 02:47:58 PM
requires maya "4.0";
requires "p3dmayaexp" "18.6";
requires "p3dSimpleShader" "18.6";
currentUnit -l meter -a degree -t ntsc;
createNode animClip -n "apu_jump_idle_take_offSource";
	setAttr ".ihi" 0;
	setAttr ".du" 14;
	setAttr ".ci" no;
...
createNode animCurveTL -n "apu_Motion_Root_translateX";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  0 -0.054075435230564878 14 -0.054075435230564878 
		35 -0.054075435230564878;
createNode animCurveTL -n "apu_Motion_Root_translateY";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  0 0 14 0 35 0;
...
select -ne :hyperGraphLayout;
	...
	setAttr ".ims" 1;
select -ne :ikSystem;
connectAttr "apu_jump_idle_take_offSource.st" "clipLibrary1.st[0]";
connectAttr "apu_jump_idle_take_offSource.du" "clipLibrary1.du[0]";
...
// End of apu_jump_idle_take_off.ma
