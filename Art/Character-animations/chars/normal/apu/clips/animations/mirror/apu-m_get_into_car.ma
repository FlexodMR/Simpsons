...
//Name: apu-m_get_into_car.ma
//Last modified: Tue, Jul 23, 2002 12:36:08 PM
requires maya "4.0";
requires "p3dmayaexp" "17.9.1.0";
requires "p3dSimpleShader" "17.1";
requires "WorldBuilder" "3.0";
currentUnit -l meter -a degree -t ntsc;
createNode animClip -n "apu_get_into_car";
	setAttr ".ihi" 0;
	setAttr ".st" 22;
	setAttr ".du" 23;
	setAttr ".ci" no;
...
createNode animCurveTL -n "animCurveTL169";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 24 ".ktv[0:23]"  22 -0.021702124217154065 23 -0.034548710602018043 
		24 -0.047395296986882017 25 -0.021702124217154065 26 0.072909048860248946 
		27 0.20605997847703869 28 0.32515569640574998 29 0.41043591414586839 30 0.4816609189563677 
		31 0.54551660624901488 32 0.61110360390404217 33 0.67605200078865002 34 0.72984188379505688 
		35 0.7619533398154813 36 0.74758949439413847 37 0.70092024433672506 38 0.6698758334276832 
		39 0.67114044338365797 40 0.68394427033031369 41 0.70003657966561894 42 0.71116663678754255 
		43 0.713410167020748 44 0.71172123982202751 45 0.71116663678754255;
	setAttr -s 24 ".kit[23]"  1;
	setAttr -s 24 ".kot[0:23]"  1 9 9 9 9 9 9 
		9 9 9 9 9 9 9 9 9 9 9 9 9 9 9 
		9 9;
...
select -ne :ikSystem;
	setAttr -s 3 ".sol";
connectAttr "apu_get_into_car.st" "clipLibrary2.st[0]";
connectAttr "apu_get_into_car.du" "clipLibrary2.du[0]";
