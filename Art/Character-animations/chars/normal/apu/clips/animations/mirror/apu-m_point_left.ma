...
//Name: apu-m_point_left.ma
//Last modified: Mon, Jul 15, 2002 05:38:32 PM
requires maya "4.0";
requires "p3dmayaexp" "17.9.1.0";
requires "p3dSimpleShader" "17.1";
requires "WorldBuilder" "3.0";
currentUnit -l meter -a degree -t ntsc;
createNode animClip -n "apu_point_left";
	setAttr ".ihi" 0;
	setAttr ".du" 23;
	setAttr ".ci" no;
...
select -ne :hyperGraphLayout;
	...
	setAttr ".ims" 1;
select -ne :ikSystem;
connectAttr "apu_point_left.st" "clipLibrary2.st[0]";
connectAttr "apu_point_left.du" "clipLibrary2.du[0]";
