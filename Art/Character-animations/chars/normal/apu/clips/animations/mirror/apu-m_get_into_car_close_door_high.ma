...
//Name: apu-m_get_into_car_close_door_high.ma
//Last modified: Tue, Jul 23, 2002 12:36:43 PM
requires maya "4.0";
requires "p3dmayaexp" "17.9.1.0";
requires "p3dSimpleShader" "17.1";
requires "WorldBuilder" "3.0";
currentUnit -l meter -a degree -t ntsc;
createNode animClip -n "apu_get_into_car_close_door_high";
	setAttr ".ihi" 0;
	setAttr ".st" 58;
	setAttr ".du" 17;
	setAttr ".ci" no;
...
select -ne :ikSystem;
	setAttr -s 3 ".sol";
connectAttr "apu_get_into_car_close_door_high.st" "clipLibrary2.st[0]";
connectAttr "apu_get_into_car_close_door_high.du" "clipLibrary2.du[0]";
...
// End of apu-m_get_into_car_close_door_high.ma
