...
//Name: apu-m_turn_180_CW.ma
//Last modified: Thu, Jun 13, 2002 12:01:48 PM
requires maya "4.0";
requires "p3dmayaexp" "17.3";
requires "p3dSimpleShader" "17.1";
currentUnit -l meter -a degree -t ntsc;
createNode animClip -n "apu_turn_180_CW";
	setAttr ".ihi" 0;
	setAttr ".du" 35;
	setAttr ".ci" no;
...
select -ne :ikSystem;
	setAttr -s 3 ".sol";
connectAttr "apu_turn_180_CW.st" "clipLibrary3.st[0]";
connectAttr "apu_turn_180_CW.du" "clipLibrary3.du[0]";
...
connectAttr "apu_turn_180_CW.st" "clipLibrary4.st[0]";
connectAttr "apu_turn_180_CW.du" "clipLibrary4.du[0]";
