...
//Name: apu_phone_hold.ma
//Last modified: Wed, Oct 09, 2002 02:49:48 PM
requires maya "4.0";
requires "p3dDeformer" "18.3";
requires "p3dmayaexp" "18.6";
requires "p3dSimpleShader" "18.6";
currentUnit -l meter -a degree -t ntsc;
createNode animClip -n "apu_phone_holdSource";
	setAttr ".ihi" 0;
	setAttr ".st" 16;
	setAttr ".du" 26;
	setAttr ".ci" no;
...
select -ne :hyperGraphLayout;
	...
	setAttr ".ims" 1;
select -ne :ikSystem;
connectAttr "apu_phone_holdSource.st" "clipLibrary1.st[0]";
connectAttr "apu_phone_holdSource.du" "clipLibrary1.du[0]";
