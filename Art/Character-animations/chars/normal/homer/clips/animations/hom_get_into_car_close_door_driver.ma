...
//Name: hom_get_into_car_close_door_driver.ma
//Last modified: Tue, Jan 07, 2003 11:32:28 AM
requires maya "4.0";
requires "p3dmayaexp" "2.0";
requires "p3dSimpleShader" "2.0";
requires "WorldBuilder" "3.0";
currentUnit -l meter -a degree -t ntsc;
createNode animClip -n "hom_get_into_car_close_door_driverSource";
	setAttr ".ihi" 0;
	setAttr ".du" 11;
	setAttr ".ci" no;
...
createNode animCurveTL -n "animCurveTL337";
	setAttr ".tan" 3;
	setAttr ".wgt" no;
	setAttr -s 2 ".ktv[0:1]"  0 -1.7084450118300396 11 -1.7084450118300396;
createNode animCurveTL -n "animCurveTL338";
	setAttr ".tan" 3;
	setAttr ".wgt" no;
	setAttr -s 2 ".ktv[0:1]"  0 0.66588912309516346 11 0.66588912309516346;
createNode animCurveTL -n "animCurveTL339";
	setAttr ".tan" 3;
	setAttr ".wgt" no;
	setAttr -s 2 ".ktv[0:1]"  0 1.9096734928140209 11 1.9096734928140209;
...
createNode animCurveTL -n "animCurveTL340";
	setAttr ".tan" 3;
	setAttr ".wgt" no;
	setAttr -s 2 ".ktv[0:1]"  0 -1.2504784321605431 11 -1.2504784321605431;
createNode animCurveTL -n "animCurveTL341";
	setAttr ".tan" 3;
	setAttr ".wgt" no;
	setAttr -s 2 ".ktv[0:1]"  0 0.67000535384055038 11 0.67000535384055038;
createNode animCurveTL -n "animCurveTL342";
	setAttr ".tan" 3;
	setAttr ".wgt" no;
	setAttr -s 2 ".ktv[0:1]"  0 1.8871381895415522 11 1.8871381895415522;
...
createNode animCurveTL -n "animCurveTL363";
	...
	setAttr -s 3 ".ktv[0:2]"  0 2.2710824495380373 5 2.6745819008249145 
		11 2.2710824495380373;
	setAttr -s 3 ".kit[2]"  3;
	setAttr -s 3 ".kot[2]"  3;
createNode animCurveTA -n "animCurveTA959";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  0 59.007910131897106 2 -34.65314174300314 
		5 -19.345874397196617 11 59.007910131897106;
	setAttr -s 4 ".kit[3]"  3;
	setAttr -s 4 ".kot[3]"  3;
createNode animCurveTA -n "animCurveTA960";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  0 -71.601588453715053 2 -61.869745702867348 
		5 -47.068687946319812 11 -71.601588453715053;
	setAttr -s 4 ".kit[3]"  3;
	setAttr -s 4 ".kot[3]"  3;
createNode animCurveTA -n "animCurveTA961";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  0 -90.779043014820601 2 16.307979948727802 
		5 7.3649226411748101 11 -90.779043014820601;
	setAttr -s 4 ".kit[3]"  3;
	setAttr -s 4 ".kot[3]"  3;
...
createNode animCurveTA -n "animCurveTA999";
	...
	setAttr -s 3 ".ktv[0:2]"  0 13.385293829723333 5 2.3811787268879385 
		11 13.385293829723333;
	setAttr -s 3 ".kit[2]"  3;
	setAttr -s 3 ".kot[2]"  3;
createNode animCurveTA -n "animCurveTA1000";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  0 0 2 30.07762742496973 5 -7.1097278539792699 
		11 0;
	setAttr -s 4 ".kit[3]"  3;
	setAttr -s 4 ".kot[3]"  3;
...
select -ne :hyperGraphLayout;
	...
	setAttr ".ims" 1;
select -ne :ikSystem;
connectAttr "hom_get_into_car_close_door_driverSource.st" "clipLibrary1.st[0]"
		;
connectAttr "hom_get_into_car_close_door_driverSource.du" "clipLibrary1.du[0]"
		;
...
// End of hom_get_into_car_close_door_driver.ma
