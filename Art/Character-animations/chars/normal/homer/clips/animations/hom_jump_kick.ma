...
//Name: hom_jump_kick.ma
//Last modified: Thu, Jan 30, 2003 11:42:21 AM
requires maya "4.0";
requires "p3dmayaexp" "18.5";
requires "p3dSimpleShader" "18.5";
currentUnit -l meter -a degree -t ntsc;
createNode animClip -n "hom_jump_kickSource";
	setAttr ".ihi" 0;
	setAttr ".du" 13.005000000000001;
	setAttr ".ci" no;
...
select -ne :hyperGraphLayout;
	...
	setAttr ".ims" 1;
select -ne :ikSystem;
connectAttr "hom_jump_kickSource.st" "clipLibrary1.st[0]";
connectAttr "hom_jump_kickSource.du" "clipLibrary1.du[0]";
