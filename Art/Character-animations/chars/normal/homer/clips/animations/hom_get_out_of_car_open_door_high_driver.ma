...
//Name: hom_get_out_of_car_open_door_high_driver.ma
//Last modified: Tue, Jul 23, 2002 01:55:30 PM
requires maya "4.0";
requires "p3dmayaexp" "17.9.1.0";
requires "p3dSimpleShader" "17.1";
requires "WorldBuilder" "3.0";
currentUnit -l meter -a degree -t ntsc;
createNode animClip -n "hom_get_out_of_car_open_door_high_driverSource";
	setAttr ".ihi" 0;
	setAttr ".du" 13;
	setAttr ".ci" no;
...
select -ne :hyperGraphLayout;
	...
	setAttr ".ims" 1;
select -ne :ikSystem;
connectAttr "hom_get_out_of_car_open_door_high_driverSource.st" "clipLibrary1.st[0]"
		;
connectAttr "hom_get_out_of_car_open_door_high_driverSource.du" "clipLibrary1.du[0]"
		;
...
// End of hom_get_out_of_car_open_door_high_driver.ma
