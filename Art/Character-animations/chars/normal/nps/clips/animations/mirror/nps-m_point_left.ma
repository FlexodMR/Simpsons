...
//Name: nps-m_point_left.ma
//Last modified: Tue, Jul 16, 2002 11:05:31 AM
requires maya "4.0";
requires "p3dmayaexp" "17.9.1.0";
requires "p3dSimpleShader" "17.1";
requires "WorldBuilder" "3.0";
currentUnit -l meter -a degree -t ntsc;
createNode animClip -n "nps_point_left";
	setAttr ".ihi" 0;
	setAttr ".du" 23;
	setAttr ".ci" no;
...
createNode animCurveTL -n "animCurveTL167";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 2 ".ktv[0:1]"  0 -0.98918496990488169 23 -0.98918496990488169;
...
select -ne :ikSystem;
	setAttr -s 3 ".sol";
connectAttr "nps_point_left.st" "clipLibrary2.st[0]";
connectAttr "nps_point_left.du" "clipLibrary2.du[0]";
