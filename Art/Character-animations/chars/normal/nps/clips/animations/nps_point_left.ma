...
//Name: nps_point_left.ma
//Last modified: Tue, Jun 17, 2003 03:39:59 PM
requires maya "4.0";
requires "p3dmayaexp" "2.0.3.0";
requires "p3dSimpleShader" "2.0";
requires "WorldBuilder" "3.0";
currentUnit -l meter -a degree -t ntsc;
createNode animClip -n "nps_point_leftSource";
	setAttr ".ihi" 0;
	setAttr ".du" 23;
	setAttr ".ci" no;
...
createNode animCurveTL -n "animCurveTL126";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 2 ".ktv[0:1]"  0 0.995 23 0.995;
...
createNode animCurveTL -n "animCurveTL132";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 6 ".ktv[0:5]"  0 1.2593194427604057 3 1.2593194427604057 
		6 1.2593194427604057 9 1.2593194427604057 18 1.2593194427604057 23 1.2593194427604057;
...
createNode animCurveTL -n "animCurveTL135";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 6 ".ktv[0:5]"  0 1.7387514454816206 3 1.7387514454816206 
		6 1.7387514454816206 9 1.7387514454816206 18 1.7387514454816206 23 1.7387514454816206;
...
createNode animCurveTL -n "animCurveTL144";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 6 ".ktv[0:5]"  0 1.398894429222125 3 1.398894429222125 
		6 1.398894429222125 9 1.398894429222125 18 1.398894429222125 23 1.398894429222125;
...
createNode animCurveTL -n "Right_Arm_Hoop_translateX";
	...
	setAttr -s 24 ".ktv[0:23]"  0 -0.38268145308384932 1 -0.38035641238049439 
		...
		10 -0.45396104481233734 11 -0.45634829335924493 12 -0.45886828629286941 13 
		-0.46119392312319318 14 -0.4630134346121112 15 -0.46402609199475764 16 -0.46393283309100741 
		17 -0.46242170950854827 18 -0.4591482304025894 19 -0.45147957373781039 20 
		-0.43808780437545725 21 -0.42065343191465898 22 -0.40128620356562977 23 -0.38268145308384932;
createNode animCurveTL -n "Right_Arm_Hoop_translateY";
	...
	setAttr -s 24 ".ktv[0:23]"  0 -0.53330786938297015 1 -0.53364970110967103 
		...
		-0.49476002960581372 14 -0.49049217436202669 15 -0.48691488272761718 16 -0.48437113531439824 
		17 -0.48320574171048181 18 -0.48376280159338148 19 -0.48836046383575493 20 
...
createNode animCurveTA -n "Right_Arm_Hoop_rotateX";
	...
	setAttr -s 24 ".ktv[0:23]"  0 4.6931680813933738 1 6.0340390044861287 
		...
		14 -42.186964393978748 15 -44.845727754262136 16 -46.859005099899086 17 -48.035087112346403 
		18 -48.136133970488821 19 -45.414351753394754 20 -38.265272457159902 21 -26.431461388374224 
...
createNode animCurveTA -n "Right_Arm_Hoop_rotateY";
	...
	setAttr -s 24 ".ktv[0:23]"  0 82.169846625535442 1 82.316405682271238 
		...
		10 77.073770202846049 11 77.130713241259656 12 77.150083458864572 13 77.147145412424365 
		14 77.148577437884114 15 77.19069630845091 16 77.316147580919065 17 77.569646992767375 
		18 77.992727409833677 19 78.825972436910263 20 80.051887557172307 21 81.24787324755782 
...
createNode animCurveTA -n "Right_Arm_Hoop_rotateZ";
	...
	setAttr -s 24 ".ktv[0:23]"  0 48.60752181821961 1 49.956351702207527 
		...
		22 33.20798667718028 23 48.60752181821961;
createNode animCurveTL -n "Left_Arm_Hoop_translateX";
	...
	setAttr -s 24 ".ktv[0:23]"  0 0.053240634577541357 1 0.12689178736941245 
		...
		10 0.53090032094294481 11 0.53025540280173289 12 0.52837223185404558 13 0.52594253999267127 
		14 0.52362489145141189 15 0.52206007801634169 16 0.52189858569718584 17 0.52384005685463908 
		18 0.52868291134941814 19 0.49992265585488044 20 0.41553491559596129 21 0.29766737762583917 
		22 0.16879139168715626 23 0.053240634577541357;
...
createNode animCurveTA -n "Left_Arm_Hoop_rotateZ";
	...
	setAttr -s 24 ".ktv[0:23]"  0 -30.60757801954853 1 31.510328790668897 
		...
		10 37.482730637092267 11 42.309290502006746 12 44.973025112620057 13 45.89686173290827 
...
createNode animCurveTL -n "animCurveTL156";
	...
	setAttr -s 6 ".ktv[0:5]"  0 2.5237365644890697 3 2.7134875218820533 
		6 2.9971114790206488 9 3.0344248794846651 18 3.052478544933642 23 2.5237365644890697;
...
select -ne :hyperGraphLayout;
	...
	setAttr ".ims" 1;
select -ne :ikSystem;
connectAttr "nps_point_leftSource.st" "clipLibrary1.st[0]";
connectAttr "nps_point_leftSource.du" "clipLibrary1.du[0]";
