...
//Name: nps_victory_large.ma
//Last modified: Tue, Jun 17, 2003 03:40:52 PM
requires maya "4.0";
requires "p3dmayaexp" "2.0.3.0";
requires "p3dSimpleShader" "2.0";
requires "WorldBuilder" "3.0";
currentUnit -l meter -a degree -t ntsc;
createNode animClip -n "nps_victory_largeSource";
	setAttr ".ihi" 0;
	setAttr ".du" 55;
	setAttr ".ci" no;
...
createNode animCurveTL -n "Right_Arm_Hoop_translateX";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 8 ".ktv[0:7]"  0 -0.069961737452636619 10 0.051519855965910397 
		16 -0.53754183448486592 19 -0.62063588446016305 23 -0.62169037461259002 38 
		-0.53754183448486592 46 -0.092741510274912897 56 -0.069961737452636619;
createNode animCurveTL -n "Right_Arm_Hoop_translateY";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 8 ".ktv[0:7]"  0 -0.68040215292634587 10 -0.079827216165454018 
		16 0.70527854121707534 19 0.63018601531877338 23 0.7059164048623191 38 0.64954705031573678 
		46 -0.26309646913629353 56 -0.68040215292634587;
	setAttr -s 8 ".kit[2:7]"  1 9 9 1 9 9;
	setAttr -s 8 ".kot[2:7]"  1 9 9 1 9 9;
	setAttr -s 8 ".kix[2:7]"  0.061895370483398438 0.96460622549057007 
		0.31090578436851501 0.031044702976942062 0.0045114043168723583 0.0079874955117702484;
	setAttr -s 8 ".kiy[2:7]"  0.99808263778686523 0.26369455456733704 
		0.95044076442718506 -0.99951797723770142 -0.99998980760574341 -0.99996811151504517;
	setAttr -s 8 ".kox[2:7]"  0.061895526945590973 0.96460622549057007 
		0.31090578436851501 0.031044678762555122 0.0045114043168723583 0.0079874955117702484;
	setAttr -s 8 ".koy[2:7]"  0.99808263778686523 0.26369455456733704 
		0.95044076442718506 -0.99951797723770142 -0.99998980760574341 -0.99996811151504517;
createNode animCurveTL -n "Right_Arm_Hoop_translateZ";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 8 ".ktv[0:7]"  0 0.56082480581367367 10 0.4609267065384563 
		16 0.094401769889690859 19 -0.017945456287600005 23 0.020791115535582119 
		38 0.094401769889690859 46 0.59863439101612526 56 0.56082480581367367;
createNode animCurveTA -n "Right_Arm_Hoop_rotateX";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 6 ".ktv[0:5]"  0 10.071237998435279 10 15.540297396544037 
		16 81.435327797145987 38 81.435327797145987 46 -25.036402721869216 56 10.071237998435279;
createNode animCurveTA -n "Right_Arm_Hoop_rotateY";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 6 ".ktv[0:5]"  0 100.48648258153693 10 175.43757019325852 
		16 168.48113850589576 38 168.48113850589576 46 112.64644099398225 56 100.48648258153693;
createNode animCurveTA -n "Right_Arm_Hoop_rotateZ";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 6 ".ktv[0:5]"  0 43.678934365861863 10 21.173143675703923 
		16 99.400701962092427 38 99.400701962092427 46 31.978567309667739 56 43.678934365861863;
createNode animCurveTL -n "Left_Arm_Hoop_translateX";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 8 ".ktv[0:7]"  0 0.090234509901407883 10 0.25215812780138602 
		16 0.37040964125908893 19 0.38673547844330652 23 0.38378133818399518 38 0.35991785095422557 
		46 0.20830351628206634 56 0.090234509901407883;
	setAttr -s 8 ".kit[5:7]"  1 9 9;
	setAttr -s 8 ".kot[5:7]"  1 9 9;
	setAttr -s 8 ".kix[5:7]"  0.13968044519424438 0.02224281057715416 
		0.028220832347869873;
	setAttr -s 8 ".kiy[5:7]"  -0.99019664525985718 -0.99975258111953735 
		-0.99960172176361084;
	setAttr -s 8 ".kox[5:7]"  0.13968054950237274 0.02224281057715416 
		0.028220832347869873;
	setAttr -s 8 ".koy[5:7]"  -0.99019664525985718 -0.99975258111953735 
		-0.99960172176361084;
createNode animCurveTL -n "Left_Arm_Hoop_translateY";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 8 ".ktv[0:7]"  0 -0.66290410418862811 10 -0.05019384026857969 
		16 0.87659683699987578 19 0.80003622359571158 23 0.8616743709618645 38 0.63418464447118095 
		46 -0.19927850072366438 56 -0.66290410418862811;
	setAttr -s 8 ".kit[2:7]"  1 9 9 1 9 9;
	setAttr -s 8 ".kot[2:7]"  1 9 9 1 9 9;
	setAttr -s 8 ".kix[2:7]"  0.062701843678951263 0.15448661148548126 
		0.038158942013978958 0.012586848810315132 0.0046256943605840206 0.0071895238943397999;
	setAttr -s 8 ".kiy[2:7]"  0.9980323314666748 -0.98799490928649902 
		-0.9992716908454895 -0.99992078542709351 -0.99998933076858521 -0.99997413158416748;
	setAttr -s 8 ".kox[2:7]"  0.062701784074306488 0.15448661148548126 
		0.038158942013978958 0.012586722150444984 0.0046256943605840206 0.0071895238943397999;
...
createNode animCurveTL -n "nps_Left_Elbow_Hoop_translateX";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  0 0.79219780621813873 16 0.65318308803971359 
		38 0.65318308803971359 56 0.79219780621813873;
createNode animCurveTL -n "nps_Left_Elbow_Hoop_translateY";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  0 -0.40574620146945284 16 -0.6053722139267802 
		38 -0.6053722139267802 56 -0.40574620146945284;
createNode animCurveTL -n "nps_Left_Elbow_Hoop_translateZ";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  0 -1.1098421401999354 16 -0.0079532694584027591 
		38 -0.0079532694584027591 56 -1.1098421401999354;
...
createNode animCurveTA -n "nps_Spine_2_rotateY";
	...
	setAttr -s 5 ".ktv[0:4]"  0 -2.0198239624003347 10 -1.5148495626712073 
		16 -2.0948672109676516 38 -2.0948672109676516 56 -2.0198239624003347;
...
select -ne :hyperGraphLayout;
	...
	setAttr ".ims" 1;
select -ne :ikSystem;
connectAttr "nps_victory_largeSource.st" "clipLibrary1.st[0]";
connectAttr "nps_victory_largeSource.du" "clipLibrary1.du[0]";
