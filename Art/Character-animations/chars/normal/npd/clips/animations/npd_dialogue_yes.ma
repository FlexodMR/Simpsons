...
//Name: npd_dialogue_yes.ma
//Last modified: Mon, Feb 17, 2003 04:25:50 PM
requires maya "4.0";
requires "p3dSimpleShader" "18.8";
requires "p3dmayaexp" "2.0";
currentUnit -l meter -a degree -t ntsc;
createNode animClip -n "npd_dialogue_yesSource";
	setAttr ".ihi" 0;
	setAttr ".du" 40;
	setAttr ".ci" no;
createNode animCurveTL -n "Extra_Attributes_translateX";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  0 1 14 1 20 1 39 1;
createNode animCurveTL -n "Extra_Attributes_translateY";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  0 0 14 0 20 0 39 0;
createNode animCurveTL -n "Motion_Root_translateX";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  0 -0.060083816922849878 14 -0.060083816922849878 
		20 -0.060083816922849878 39 -0.060083816922849878;
...
createNode animCurveTL -n "Right_Foot_Hoop_translateX";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  0 -0.22948570846143723 14 -0.22948570846143723 
		20 -0.22948570846143723 39 -0.22948570846143723;
createNode animCurveTL -n "Right_Foot_Hoop_translateY";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  0 0.13964711708164665 14 0.13964711708164665 
		20 0.13964711708164665 39 0.13964711708164665;
createNode animCurveTL -n "Right_Foot_Hoop_translateZ";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  0 -0.064904406754016042 14 -0.064904406754016042 
		20 -0.064904406754016042 39 -0.064904406754016042;
...
createNode animCurveTA -n "Right_Foot_Hoop_rotateY";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  0 -12.031576538165265 14 -12.031576538165265 
		20 -12.031576538165265 39 -12.031576538165265;
...
createNode animCurveTL -n "Left_Foot_Hoop_translateX";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  0 0.10825868069997467 14 0.10825868069997467 
		20 0.10825868069997467 39 0.10825868069997467;
createNode animCurveTL -n "Left_Foot_Hoop_translateY";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  0 0.13791212285411131 14 0.13791212285411131 
		20 0.13791212285411131 39 0.13791212285411131;
createNode animCurveTL -n "Left_Foot_Hoop_translateZ";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  0 -0.10454507572235824 14 -0.10454507572235824 
		20 -0.10454507572235824 39 -0.10454507572235824;
...
createNode animCurveTA -n "Left_Foot_Hoop_rotateY";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  0 18.635117457566011 14 18.635117457566011 
		20 18.635117457566011 39 18.635117457566011;
...
createNode animCurveTL -n "Character_Hoop_translateX";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  0 -0.0052529700667724097 14 -0.0052529700667724097 
		20 -0.0052529700667724097 39 -0.0052529700667724097;
createNode animCurveTL -n "Character_Hoop_translateY";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  0 0.9912550528809112 14 0.9912550528809112 
		20 0.9912550528809112 39 0.9912550528809112;
...
createNode animCurveTL -n "Right_Arm_Hoop_translateX";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  0 -0.22164053326398034 14 -0.22164053326398034 
		20 -0.22164053326398034 39 -0.22164053326398034;
createNode animCurveTL -n "Right_Arm_Hoop_translateY";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 5 ".ktv[0:4]"  0 -0.9417076481617882 7 -0.92489475030368129 
		14 -0.9367163190659461 20 -0.93128689887096916 39 -0.9417076481617882;
createNode animCurveTL -n "Right_Arm_Hoop_translateZ";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 5 ".ktv[0:4]"  0 0.038362195289875119 7 0.037983043802464332 
		14 0.038249634687041179 20 0.038127194596247908 39 0.038362195289875119;
createNode animCurveTA -n "Right_Arm_Hoop_rotateX";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  0 6.7230119492284173 14 6.7230119492284173 
		20 6.7230119492284173 39 6.7230119492284173;
createNode animCurveTA -n "Right_Arm_Hoop_rotateY";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  0 19.839511008631867 14 19.839511008631867 
		20 19.839511008631867 39 19.839511008631867;
createNode animCurveTA -n "Right_Arm_Hoop_rotateZ";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  0 76.90743997913691 14 76.90743997913691 
		20 76.90743997913691 39 76.90743997913691;
createNode animCurveTL -n "Left_Arm_Hoop_translateX";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  0 0.20623790699604494 14 0.20623790699604494 
		20 0.20623790699604494 39 0.20623790699604494;
createNode animCurveTL -n "Left_Arm_Hoop_translateY";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 5 ".ktv[0:4]"  0 -0.94615818397708606 7 -0.92934528611897915 
		14 -0.94116685488124407 20 -0.93573743468626702 39 -0.94615818397708606;
createNode animCurveTL -n "Left_Arm_Hoop_translateZ";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 5 ".ktv[0:4]"  0 0.023808763748733922 7 0.023429612261323132 
		14 0.023696203145899979 20 0.023573763055106715 39 0.023808763748733922;
createNode animCurveTA -n "Left_Arm_Hoop_rotateX";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  0 8.1910546202722809 14 8.1910546202722809 
		20 8.1910546202722809 39 8.1910546202722809;
createNode animCurveTA -n "Left_Arm_Hoop_rotateY";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  0 -16.680769289981995 14 -16.680769289981995 
		20 -16.680769289981995 39 -16.680769289981995;
createNode animCurveTA -n "Left_Arm_Hoop_rotateZ";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  0 -64.609749241846473 14 -64.609749241846473 
		20 -64.609749241846473 39 -64.609749241846473;
createNode animCurveTL -n "Right_Arm_World_translateX";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  0 -0.8448236677023373 14 -0.8448236677023373 
		20 -0.8448236677023373 39 -0.8448236677023373;
createNode animCurveTL -n "Right_Arm_World_translateY";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  0 1.5117481219250299 14 1.5117481219250299 
		20 1.5117481219250299 39 1.5117481219250299;
createNode animCurveTL -n "Right_Arm_World_translateZ";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  0 -0.097994651149805143 14 -0.097994651149805143 
		20 -0.097994651149805143 39 -0.097994651149805143;
createNode animCurveTA -n "Right_Arm_World_rotateX";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  0 5.4739599453216474 14 5.4739599453216474 
		20 5.4739599453216474 39 5.4739599453216474;
createNode animCurveTA -n "Right_Arm_World_rotateY";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  0 8.5874521608419823 14 8.5874521608419823 
		20 8.5874521608419823 39 8.5874521608419823;
createNode animCurveTA -n "Right_Arm_World_rotateZ";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  0 74.754744621954103 14 74.754744621954103 
		20 74.754744621954103 39 74.754744621954103;
createNode animCurveTL -n "Left_Arm_World_translateX";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  0 0.61083301393139333 14 0.61083301393139333 
		20 0.61083301393139333 39 0.61083301393139333;
createNode animCurveTL -n "Left_Arm_World_translateY";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  0 1.4644416293758407 14 1.4644416293758407 
		20 1.4644416293758407 39 1.4644416293758407;
createNode animCurveTL -n "Left_Arm_World_translateZ";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  0 0.14314299916678522 14 0.14314299916678522 
		20 0.14314299916678522 39 0.14314299916678522;
createNode animCurveTA -n "Left_Arm_World_rotateX";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  0 16.226511010665405 14 16.226511010665405 
		20 16.226511010665405 39 16.226511010665405;
createNode animCurveTA -n "Left_Arm_World_rotateY";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  0 -8.513966085499284 14 -8.513966085499284 
		20 -8.513966085499284 39 -8.513966085499284;
createNode animCurveTA -n "Left_Arm_World_rotateZ";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  0 -68.213989601412422 14 -68.213989601412422 
		20 -68.213989601412422 39 -68.213989601412422;
...
createNode animCurveTL -n "Right_Elbow_Hoop_translateX";
	...
	setAttr -s 4 ".ktv[0:3]"  0 -0.10167917362943303 14 -0.10167917362943303 
		20 -0.10167917362943303 39 -0.10167917362943303;
createNode animCurveTL -n "Right_Elbow_Hoop_translateY";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  0 -0.40762644910266188 14 -0.40762644910266188 
		20 -0.40762644910266188 39 -0.40762644910266188;
createNode animCurveTL -n "Right_Elbow_Hoop_translateZ";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  0 -0.93129112588482243 14 -0.93129112588482243 
		20 -0.93129112588482243 39 -0.93129112588482243;
createNode animCurveTA -n "R_FK_Shoulder_rotateX";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  0 12.253734489678925 14 12.253734489678925 
		20 12.253734489678925 39 12.253734489678925;
createNode animCurveTA -n "R_FK_Shoulder_rotateY";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  0 -65.746751280844961 14 -65.746751280844961 
		20 -65.746751280844961 39 -65.746751280844961;
createNode animCurveTA -n "R_FK_Shoulder_rotateZ";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  0 3.871449260799477e-015 14 0 20 
		0 39 0;
createNode animCurveTA -n "L_FK_Shoulder_rotateX";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  0 -0.061808866237337522 14 -0.061808866237337522 
		20 -0.061808866237337522 39 -0.061808866237337522;
createNode animCurveTA -n "L_FK_Shoulder_rotateY";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  0 -59.058178941076754 14 -59.058178941076754 
		20 -59.058178941076754 39 -59.058178941076754;
createNode animCurveTA -n "L_FK_Shoulder_rotateZ";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  0 16.579147429757843 14 16.579147429757843 
		20 16.579147429757843 39 16.579147429757843;
createNode animCurveTA -n "R_FK_Elbow_rotateZ";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  0 8.5572674112203622 14 8.5572674112203622 
		20 8.5572674112203622 39 8.5572674112203622;
createNode animCurveTA -n "L_FK_Elbow_rotateZ";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  0 15.711328223519057 14 15.711328223519057 
		20 15.711328223519057 39 15.711328223519057;
...
createNode animCurveTA -n "Thumb_Base_L_rotateX";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  0 10.423754966968488 14 10.423754966968488 
		20 10.423754966968488 39 10.423754966968488;
createNode animCurveTA -n "Thumb_Base_L_rotateY";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  0 27.722848255843903 14 27.722848255843903 
		20 27.722848255843903 39 27.722848255843903;
createNode animCurveTA -n "Thumb_Base_L_rotateZ";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  0 21.576484776388227 14 21.576484776388227 
		20 21.576484776388227 39 21.576484776388227;
...
createNode animCurveTA -n "Middle_Base_L_rotateZ";
	...
	setAttr -s 4 ".ktv[0:3]"  0 27.080064458283051 14 27.080064458283051 
		20 27.080064458283051 39 27.080064458283051;
...
createNode animCurveTA -n "Thumb_R_rotateZ";
	...
	setAttr -s 4 ".ktv[0:3]"  0 13.994403295754109 14 13.994403295754109 
		20 13.994403295754109 39 13.994403295754109;
...
createNode animCurveTA -n "Middle_R_rotateZ";
	...
	setAttr -s 4 ".ktv[0:3]"  0 27.911632519594587 14 27.911632519594587 
		20 27.911632519594587 39 27.911632519594587;
...
createNode animCurveTA -n "Spine_2_rotateZ";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 5 ".ktv[0:4]"  0 0 7 1.2918712010013078 14 0.38352425973169957 
		20 0.80071061801954979 39 0;
...
createNode animCurveTA -n "Neck_rotateZ";
	...
	setAttr -s 5 ".ktv[0:4]"  0 0 7 7.9308011105049889 14 2.7633526172010727 
		20 5.9670144834762038 39 0;
	setAttr -s 5 ".kit[3:4]"  1 9;
	setAttr -s 5 ".kot[3:4]"  1 9;
	setAttr -s 5 ".kix[3:4]"  0.9817434549331665 0.98674821853637695;
	setAttr -s 5 ".kiy[3:4]"  0.19020979106426239 -0.16225889325141907;
	setAttr -s 5 ".kox[3:4]"  0.9817434549331665 0.98674821853637695;
	setAttr -s 5 ".koy[3:4]"  0.19020974636077881 -0.16225889325141907;
createNode animCurveTA -n "Head_rotateX";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 5 ".ktv[0:4]"  0 -4.9367554394300077 7 -7.5635700811419921 
		14 -5.7165910429079396 20 -6.5648731616722058 39 -4.9367554394300077;
createNode animCurveTA -n "Head_rotateY";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 5 ".ktv[0:4]"  0 -8.6986303327609935 7 -6.5492107333627922 
		14 -8.0605213684330064 20 -7.366405326130681 39 -8.6986303327609935;
createNode animCurveTA -n "Head_rotateZ";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 5 ".ktv[0:4]"  0 17.455917002855632 7 30.029576388750591 
		14 21.51836273921953 20 25.375422838707479 39 17.455917002855632;
...
createNode animCurveTA -n "Middle_Base_R_rotateZ";
	...
	setAttr -s 4 ".ktv[0:3]"  0 33.429092416277157 14 33.429092416277157 
		20 33.429092416277157 39 33.429092416277157;
createNode animCurveTA -n "Thumb_Base_R_rotateX";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  0 8.2533422302317216 14 8.2533422302317216 
		20 8.2533422302317216 39 8.2533422302317216;
createNode animCurveTA -n "Thumb_Base_R_rotateY";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  0 23.263402056531085 14 23.263402056531085 
		20 23.263402056531085 39 23.263402056531085;
createNode animCurveTA -n "Thumb_Base_R_rotateZ";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  0 20.166277752815617 14 20.166277752815617 
		20 20.166277752815617 39 20.166277752815617;
...
createNode animCurveTA -n "Middle_L_rotateZ";
	...
	setAttr -s 4 ".ktv[0:3]"  0 17.254116939558369 14 17.254116939558369 
		20 17.254116939558369 39 17.254116939558369;
...
select -ne :hyperGraphLayout;
	...
	setAttr ".ims" 1;
select -ne :ikSystem;
connectAttr "npd_dialogue_yesSource.st" "clipLibrary1.st[0]";
connectAttr "npd_dialogue_yesSource.du" "clipLibrary1.du[0]";
