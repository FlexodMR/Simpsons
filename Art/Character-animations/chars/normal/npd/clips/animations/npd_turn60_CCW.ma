...
//Name: npd_turn60_CCW.ma
//Last modified: Thu, May 29, 2003 03:45:40 PM
requires maya "4.0";
...
select -ne :ikSystem;
	setAttr -s 3 ".sol";
connectAttr "npd_turn60_CCW.st" "clipLibrary2.st[0]";
connectAttr "npd_turn60_CCW.du" "clipLibrary2.du[0]";
