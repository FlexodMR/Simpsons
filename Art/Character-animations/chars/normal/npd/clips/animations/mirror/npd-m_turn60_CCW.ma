...
//Name: npd-m_turn60_CCW.ma
//Last modified: Thu, May 29, 2003 03:45:44 PM
requires maya "4.0";
requires "p3dmayaexp" "2.0.3.0";
requires "p3dSimpleShader" "2.0";
currentUnit -l meter -a degree -t ntsc;
createNode animClip -n "npd_turn60_CCW";
	setAttr ".ihi" 0;
	setAttr ".du" 12;
	setAttr ".ci" no;
...
createNode animCurveTL -n "animCurveTL251";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 2 ".ktv[0:1]"  0 0.027000000000000003 12 0.027000000000000003;
...
createNode animCurveTL -n "animCurveTL268";
	...
	setAttr -s 5 ".koy[3:4]"  0.98401552438735962 0.99754065275192261;
createNode animCurveTL -n "animCurveTL269";
	...
	setAttr -s 5 ".kiy[1:4]"  0.96835184097290039 0.99744129180908203 
		0.98847693204879761 -0.99847173690795898;
	setAttr -s 5 ".kox[1:4]"  0.24958889186382294 0.071490302681922913 
		0.15137238800525665 0.055264223366975784;
	setAttr -s 5 ".koy[1:4]"  0.96835184097290039 0.99744129180908203 
...
select -ne :ikSystem;
	setAttr -s 3 ".sol";
connectAttr "npd_turn60_CCW.st" "clipLibrary3.st[0]";
connectAttr "npd_turn60_CCW.du" "clipLibrary3.du[0]";
...
connectAttr "npd_turn60_CCW.st" "clipLibrary4.st[0]";
connectAttr "npd_turn60_CCW.du" "clipLibrary4.du[0]";
