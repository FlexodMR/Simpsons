...
//Name: frk_turn_180_CW.ma
//Last modified: Tue, Jun 18, 2002 03:19:29 PM
requires maya "4.0";
requires "p3dmayaexp" "17.6";
requires "p3dSimpleShader" "17.1";
currentUnit -l meter -a degree -t ntsc;
createNode animClip -n "frk_turn_180_CWSource";
	setAttr ".ihi" 0;
	setAttr ".du" 44;
	setAttr ".ci" no;
...
createNode animCurveTL -n "animCurveTL618";
	...
	setAttr -s 36 ".ktv[0:35]"  0 0.021611233900292327 1 -0.0071023745764177424 
		2 -0.036251991686183864 3 -0.064529587201119454 4 -0.090627130893337904 5 
		-0.11084337512361092 6 -0.12581781099730951 7 -0.13903852293245555 8 -0.14697869647280515 
		9 -0.14896252946151786 10 -0.14874210357388312 11 -0.14763997413570937 12 
		-0.14697869647280515 13 -0.14697869647280515 14 -0.14697869647280515 15 -0.14697869647280515 
		16 -0.14697869647280515 17 -0.14697869647280515 18 -0.14697869647280515 19 
		-0.14697869647280515 20 -0.14697869647280515 21 -0.14697869647280515 22 -0.14697869647280515 
		23 -0.14697869647280515 24 -0.14697869647280515 25 -0.14697869647280515 26 
		-0.14697869647280515 27 -0.14697869647280515 28 -0.14449976152386443 29 -0.14036820327562988 
		30 -0.13954189162598296 31 -0.14697869647280515 32 -0.18163096230757575 33 
		-0.22630461933335952 34 -0.25476899157758071 35 -0.28003377327665219;
...
createNode animCurveTA -n "animCurveTA1696";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 2 ".ktv[0:1]"  12 0 27 180;
...
createNode animCurveTL -n "animCurveTL624";
	...
	setAttr -s 9 ".ktv[0:8]"  0 -0.13256050696689195 4 -0.13256050696689195 
		6 -0.13256050696689195 8 -0.13256050696689195 12 -0.13256050696689195 27 
		-0.13256050696689195 31 -0.13256050696689195 33 -0.13256050696689195 35 -0.13256050696689195;
...
createNode animCurveTL -n "animCurveTL627";
	...
	setAttr -s 10 ".ktv[0:9]"  0 0.18579966735506592 4 0.24845707114529361 
		6 -0.17124968813950189 8 -0.52218257780004185 10 -0.57034755526043646 12 
		-0.52218257780004185 27 -0.52218257780004185 31 -0.52218257780004185 33 -0.52218257780004185 
		35 -0.52218257780004185;
...
createNode animCurveTL -n "animCurveTL629";
	...
	setAttr -s 10 ".kiy[3:9]"  -0.99998050928115845 0.99999880790710449 
		0.99992436170578003 0 -0.99996280670166016 0 0;
	setAttr -s 10 ".kox[3:9]"  0.0062423320487141609 0.0015247386181727052 
		0.012297773733735085 1 0.0086271725594997406 1 1;
	setAttr -s 10 ".koy[3:9]"  -0.99998050928115845 0.99999880790710449 
		0.99992436170578003 0 -0.99996280670166016 0 0;
...
createNode animCurveTL -n "animCurveTL636";
	...
	setAttr -s 9 ".ktv[0:8]"  0 0.03056236763751306 4 -0.12816388481445035 
		6 -0.17793015488092484 8 -0.20785564476369636 12 -0.20785564476369636 27 
		-0.20785564476369636 31 -0.20785564476369636 33 -0.32003748633899259 35 -0.39602066079555298;
...
createNode animCurveTA -n "animCurveTA1715";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr ".ktv[0]"  1 0.040709616517141577;
createNode animCurveTA -n "animCurveTA1716";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr ".ktv[0]"  1 -1.8313983219776933;
createNode animCurveTA -n "animCurveTA1717";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr ".ktv[0]"  1 3.7337164321498379;
createNode animCurveTA -n "animCurveTA1718";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr ".ktv[0]"  1 -2.5673169553733395;
createNode animCurveTA -n "animCurveTA1719";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr ".ktv[0]"  1 -5.938383166068367;
createNode animCurveTA -n "animCurveTA1720";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr ".ktv[0]"  1 -0.00040252039393782536;
createNode animCurveTA -n "animCurveTA1721";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr ".ktv[0]"  1 -1.1571952141288733;
...
createNode animCurveTA -n "animCurveTA1724";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr ".ktv[0]"  1 0.0034456079181433771;
createNode animCurveTA -n "animCurveTA1725";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr ".ktv[0]"  1 0.040473860579884585;
createNode animCurveTA -n "animCurveTA1726";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr ".ktv[0]"  1 -1.8313984519406281;
createNode animCurveTA -n "animCurveTA1727";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr ".ktv[0]"  1 3.7337164553688731;
createNode animCurveTA -n "animCurveTA1728";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr ".ktv[0]"  1 -2.5673170049738836;
createNode animCurveTA -n "animCurveTA1729";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr ".ktv[0]"  1 -5.9383298724540099;
createNode animCurveTA -n "animCurveTA1730";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr ".ktv[0]"  1 -0.00017158844849065358;
createNode animCurveTA -n "animCurveTA1731";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr ".ktv[0]"  1 -1.1571951880326767;
...
createNode animCurveTA -n "animCurveTA1734";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr ".ktv[0]"  1 0.0034456079182833216;
...
createNode animCurveTL -n "animCurveTL645";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr ".ktv[0]"  1 -1.3848817703086196;
createNode animCurveTL -n "animCurveTL646";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr ".ktv[0]"  1 2.3971606112795563;
createNode animCurveTL -n "animCurveTL647";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr ".ktv[0]"  1 -0.14844372651139698;
...
createNode animCurveTL -n "animCurveTL648";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr ".ktv[0]"  1 1.3848820121487373;
createNode animCurveTL -n "animCurveTL649";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr ".ktv[0]"  1 2.397161655727015;
createNode animCurveTL -n "animCurveTL650";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr ".ktv[0]"  1 -0.14844368205557412;
...
createNode animCurveTA -n "animCurveTA1778";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr ".ktv[0]"  1 12.085861696683486;
...
select -ne :hyperGraphLayout;
	...
	setAttr ".ims" 1;
select -ne :ikSystem;
connectAttr "frk_turn_180_CWSource.st" "clipLibrary1.st[0]";
connectAttr "frk_turn_180_CWSource.du" "clipLibrary1.du[0]";
...
connectAttr "animCurveTU123.a" "clipLibrary1.cel[0].cev[12].cevr";
connectAttr "animCurveTU124.a" "clipLibrary1.cel[0].cev[13].cevr";
...
connectAttr "animCurveTL630.a" "clipLibrary1.cel[0].cev[38].cevr";
connectAttr "animCurveTL631.a" "clipLibrary1.cel[0].cev[39].cevr";
connectAttr "animCurveTL632.a" "clipLibrary1.cel[0].cev[40].cevr";
connectAttr "animCurveTL633.a" "clipLibrary1.cel[0].cev[41].cevr";
connectAttr "animCurveTL634.a" "clipLibrary1.cel[0].cev[42].cevr";
connectAttr "animCurveTL635.a" "clipLibrary1.cel[0].cev[43].cevr";
connectAttr "animCurveTL636.a" "clipLibrary1.cel[0].cev[44].cevr";
connectAttr "animCurveTL637.a" "clipLibrary1.cel[0].cev[45].cevr";
connectAttr "animCurveTL638.a" "clipLibrary1.cel[0].cev[46].cevr";
connectAttr "animCurveTA1712.a" "clipLibrary1.cel[0].cev[47].cevr";
connectAttr "animCurveTA1713.a" "clipLibrary1.cel[0].cev[48].cevr";
connectAttr "animCurveTA1714.a" "clipLibrary1.cel[0].cev[49].cevr";
connectAttr "animCurveTA1715.a" "clipLibrary1.cel[0].cev[50].cevr";
connectAttr "animCurveTA1716.a" "clipLibrary1.cel[0].cev[51].cevr";
connectAttr "animCurveTA1717.a" "clipLibrary1.cel[0].cev[52].cevr";
...
connectAttr "animCurveTL639.a" "clipLibrary1.cel[0].cev[76].cevr";
connectAttr "animCurveTL640.a" "clipLibrary1.cel[0].cev[77].cevr";
connectAttr "animCurveTL641.a" "clipLibrary1.cel[0].cev[78].cevr";
connectAttr "animCurveTA1741.a" "clipLibrary1.cel[0].cev[79].cevr";
connectAttr "animCurveTA1742.a" "clipLibrary1.cel[0].cev[80].cevr";
connectAttr "animCurveTA1743.a" "clipLibrary1.cel[0].cev[81].cevr";
connectAttr "animCurveTL642.a" "clipLibrary1.cel[0].cev[82].cevr";
connectAttr "animCurveTL643.a" "clipLibrary1.cel[0].cev[83].cevr";
connectAttr "animCurveTL644.a" "clipLibrary1.cel[0].cev[84].cevr";
connectAttr "animCurveTA1744.a" "clipLibrary1.cel[0].cev[85].cevr";
connectAttr "animCurveTA1745.a" "clipLibrary1.cel[0].cev[86].cevr";
connectAttr "animCurveTA1746.a" "clipLibrary1.cel[0].cev[87].cevr";
connectAttr "animCurveTL645.a" "clipLibrary1.cel[0].cev[88].cevr";
connectAttr "animCurveTL646.a" "clipLibrary1.cel[0].cev[89].cevr";
connectAttr "animCurveTL647.a" "clipLibrary1.cel[0].cev[90].cevr";
connectAttr "animCurveTA1747.a" "clipLibrary1.cel[0].cev[91].cevr";
connectAttr "animCurveTA1748.a" "clipLibrary1.cel[0].cev[92].cevr";
connectAttr "animCurveTA1749.a" "clipLibrary1.cel[0].cev[93].cevr";
connectAttr "animCurveTL648.a" "clipLibrary1.cel[0].cev[94].cevr";
connectAttr "animCurveTL649.a" "clipLibrary1.cel[0].cev[95].cevr";
connectAttr "animCurveTL650.a" "clipLibrary1.cel[0].cev[96].cevr";
connectAttr "animCurveTA1750.a" "clipLibrary1.cel[0].cev[97].cevr";
connectAttr "animCurveTA1751.a" "clipLibrary1.cel[0].cev[98].cevr";
connectAttr "animCurveTA1752.a" "clipLibrary1.cel[0].cev[99].cevr";
connectAttr "animCurveTL651.a" "clipLibrary1.cel[0].cev[100].cevr";
connectAttr "animCurveTL652.a" "clipLibrary1.cel[0].cev[101].cevr";
connectAttr "animCurveTL653.a" "clipLibrary1.cel[0].cev[102].cevr";
connectAttr "animCurveTL654.a" "clipLibrary1.cel[0].cev[103].cevr";
connectAttr "animCurveTL655.a" "clipLibrary1.cel[0].cev[104].cevr";
connectAttr "animCurveTL656.a" "clipLibrary1.cel[0].cev[105].cevr";
connectAttr "animCurveTA1753.a" "clipLibrary1.cel[0].cev[106].cevr";
connectAttr "animCurveTA1754.a" "clipLibrary1.cel[0].cev[107].cevr";
connectAttr "animCurveTA1755.a" "clipLibrary1.cel[0].cev[108].cevr";
connectAttr "animCurveTA1756.a" "clipLibrary1.cel[0].cev[109].cevr";
connectAttr "animCurveTA1757.a" "clipLibrary1.cel[0].cev[110].cevr";
connectAttr "animCurveTA1758.a" "clipLibrary1.cel[0].cev[111].cevr";
