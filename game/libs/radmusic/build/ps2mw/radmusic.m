...
radmusic_x :
	...
	@echo -----------------------------
	@$(ROOTDIR)\\radbuild\\globaltools\\make --no-print-directory -r -C $(ROOTDIR)/radmusic/build/ps2mw

radmusic_x_clean :
	@echo Cleaning radmusic library ...
	@echo -----------------------------
	@$(ROOTDIR)\\radbuild\\globaltools\\make --no-print-directory -r -C $(ROOTDIR)/radmusic/build/ps2mw clean
