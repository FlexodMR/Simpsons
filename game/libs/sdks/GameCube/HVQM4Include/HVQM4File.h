...
/*
 * File:	HVQM4File.h (HVQM4 1.5)
 *
 * (C) 2000-2001 HUDSON SOFT
 *
 *  2001-12-05  Itagaki  Adapted for "HVQM4 1.5"
 *                       Delete HVQM4_FILEVERSION literal string definition
 *                       Made an adjustment for __cplusplus
 */
...
typedef struct {
  ...
  u8  audio_codec;		/* Audio codec type */
  u8  multi_track;		/* multi-track info. */
