...
!MESSAGE 
!MESSAGE NMAKE /f "remotecommand.mak" CFG="remotecommand - Xbox Debug"
!MESSAGE 
!MESSAGE Possible choices for configuration are:
!MESSAGE 
!MESSAGE "remotecommand - Xbox Release" (based on "Xbox Application")
!MESSAGE "remotecommand - Xbox Debug" (based on "Xbox Application")
!MESSAGE "remotecommand - Xbox Tune" (based on "Xbox Application")
!MESSAGE 
...
!IF  "$(CFG)" == "remotecommand - Xbox Release"
...
# ADD LINK32 xapilib.lib d3d8.lib d3dx8.lib xgraphics.lib dsound.lib dmusic.lib xnet.lib xboxkrnl.lib /nologo /machine:I386 /out:"..\..\bin\remotecommandxr.exe" /libpath:"..\..\..\lib" /subsystem:xbox /fixed:no /tmp
XBE=imagebld.exe
...
!ELSEIF  "$(CFG)" == "remotecommand - Xbox Debug"
...
# ADD LINK32 xapilibd.lib d3d8d.lib d3dx8d.lib xgraphicsd.lib dsoundd.lib dmusicd.lib xnetd.lib xboxkrnl.lib /nologo /incremental:no /debug /machine:I386 /out:"..\..\bin\remotecommandxd.exe" /libpath:"..\..\..\lib" /subsystem:xbox /fixed:no /tmp
XBE=imagebld.exe
...
!ELSEIF  "$(CFG)" == "remotecommand - Xbox Tune"
...
LINK32=link.exe
# ADD BASE LINK32 xapilib.lib d3d8.lib d3dx8.lib xgraphics.lib dsound.lib dmusic.lib xnet.lib xboxkrnl.lib /nologo /machine:I386 /subsystem:xbox /fixed:no /tmp
# ADD LINK32 xapilib.lib d3d8.lib d3dx8.lib xgraphics.lib dsound.lib dmusic.lib xnet.lib xboxkrnl.lib /nologo /machine:I386 /out:"..\..\bin\remotecommandxt.exe" /libpath:"..\..\..\lib" /subsystem:xbox /fixed:no /tmp
XBE=imagebld.exe
# ADD BASE XBE /nologo /stack:0x10000
# ADD XBE /nologo /stack:0x10000
XBCP=xbecopy.exe
...
# Name "remotecommand - Xbox Release"
# Name "remotecommand - Xbox Debug"
# Name "remotecommand - Xbox Tune"
