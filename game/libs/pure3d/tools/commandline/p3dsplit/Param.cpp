    ...
    Files( )
{
    ...
    static struct option long_options[] = {
      ...
      {"xDiv",required_argument,NULL,0},
      {"zDiv",required_argument,NULL,0},
      {"splitType",required_argument,NULL,0},
      {"geoName",required_argument,NULL,0},
      {"help",no_argument,NULL,0},
      {0,0,0,0}
    };
    while ((ch = getopt_long(argc, argv, "?hHvVRP:no:x:z:t:s:",long_options,&option_index)) != EOF)
    {
        switch(ch)
        {
            ...
            switch(option_index)
            {
                ...
                case 2:   // zDiv
                    ...
                    break;
                case 3:   // splitType
                        splitType = atoi(optarg);
                    break;
                case 4:   // geoName
                        geoName = strnew(optarg);
                    break;
                case 5:   // help
                    Usage();
                    break;
...
Parameters::Usage()
{
    ...
    puts( "\nCopyright Radical Entertainment 2015\n\n"
         ...
         "-x, --xDiv int          Specify num of x axis world divisions\n"
         "-z, --zDiv int          Specify num of z axis world divisions\n"
         "-t, --splitType int     Specify how to divide the world: 0: cut 1:\n"
         "                         tear\n"
         "-s, --geoName name      Specify name of the new compoundMesh\n"
            "\n"
            "Standard options:\n"
...
Parameters::HistoryChunk()
{
    tlHistory history;
    char buf[512];
    sprintf(buf,"p3dsplit version %s (with ATG %s)", version, ATG_VERSION);
    history.AddLine(buf);
    char* b = buf;
    int i;
    for( i = 0; i < Argc; i++)
