/*===========================================================================
    Automatically generated by Jeeves, don't edit.  Edit p3dsort.sc instead

    File: Param.cpp 

    Command line parameters for p3dsort
    ...
    Files( )
{
    ...
    static struct option long_options[] = {
      ...
      {"set-alphas",no_argument,NULL,0},
      {"help",no_argument,NULL,0},
      {0,0,0,0}
    };
    while ((ch = getopt_long(argc, argv, "?hHvVRP:no:s",long_options,&option_index)) != EOF)
    {
        switch(ch)
        {
...
Parameters::Usage()
{
    ...
    puts( "\nCopyright Radical Entertainment 2015\n\n"
         ...
         "-s, --set-alphas        Set alphas of dsg objects\n"
            "\n"
            "Standard options:\n"
...
Parameters::HistoryChunk()
{
    tlHistory history;
    char buf[512];
    sprintf(buf,"p3dsort version %s (with ATG %s)", version, ATG_VERSION);
    history.AddLine(buf);
    char* b = buf;
    int i;
    for( i = 0; i < Argc; i++)
