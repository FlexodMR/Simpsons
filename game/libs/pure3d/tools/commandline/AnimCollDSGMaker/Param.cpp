/*===========================================================================
    Automatically generated by Jeeves, don't edit.  Edit AnimCollDSGMaker.sc instead

    File: Param.cpp 

    Command line parameters for AnimCollDSGMaker
...
{
    printf("AnimCollDSGMaker version %s\n",version);
    printf("Using ATG %s Changelist %s %s\n", ATG_VERSION, compileChangelist, compileTime);
    puts( "\nCopyright Radical Entertainment 2015\n\n"
            "   Usage: AnimCollDSGMaker [options] <inputfile> [<inputfile> ...]\n\n"

         "This tool searches a pure3d file and wraps the Comp Drawable and Framecontroller \n"
         "together\n"
            "\n"
            "Try AnimCollDSGMaker --help for more info.\n");
    exit(1);
}
...
Parameters::HistoryChunk()
{
    tlHistory history;
    char buf[512];
    sprintf(buf,"AnimCollDSGMaker version %s (with ATG %s)", version, ATG_VERSION);
    history.AddLine(buf);
    char* b = buf;
    int i;
    for( i = 0; i < Argc; i++)
