/*===========================================================================
    Automatically generated by Jeeves, don't edit.  Edit p3dgeo2prims.sc instead

    File: Param.cpp 

    Command line parameters for p3dgeo2prims
...
{
    printf("p3dgeo2prims version %s\n",version);
    printf("Using ATG %s Changelist %s %s\n", ATG_VERSION, compileChangelist, compileTime);
    puts( "\nCopyright Radical Entertainment 2015\n\n"
            "   Usage: p3dgeo2prims [options] <inputfile> [<inputfile> ...]\n\n"

         "This tool splits every geo in the file into it's component primgroups, such that \n"
         "each primgroup has its own geo\n"
            "\n"
            "Try p3dgeo2prims --help for more info.\n");
    exit(1);
}
...
Parameters::HistoryChunk()
{
    tlHistory history;
    char buf[512];
    sprintf(buf,"p3dgeo2prims version %s (with ATG %s)", version, ATG_VERSION);
    history.AddLine(buf);
    char* b = buf;
    int i;
    for( i = 0; i < Argc; i++)
