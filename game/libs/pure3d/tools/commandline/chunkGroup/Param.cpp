    ...
    Files( )
{
    ...
    static struct option long_options[] = {
      ...
      {"testlist",required_argument,NULL,0},
      {"byname",no_argument,NULL,0},
      {"help",no_argument,NULL,0},
      {0,0,0,0}
    };
    while ((ch = getopt_long(argc, argv, "?hHvVRP:no:t:b",long_options,&option_index)) != EOF)
    {
        switch(ch)
        {
...
Parameters::Usage()
{
    ...
    puts( "\nCopyright Radical Entertainment 2015\n\n"
         ...
         "-t, --testlist ID       Test only these chunks.\n"
         "-b, --byname            Only test the names (and type) of the chunks.\n"
            "\n"
            "Standard options:\n"
...
Parameters::HistoryChunk()
{
    tlHistory history;
    char buf[512];
    sprintf(buf,"chunkGroup version %s (with ATG %s)", version, ATG_VERSION);
    history.AddLine(buf);
    char* b = buf;
    int i;
    for( i = 0; i < Argc; i++)
