/*===========================================================================
    Automatically generated by Jeeves, don't edit.  Edit LensFlareDSGMaker.sc instead

    File: Param.cpp 

    Command line parameters for LensFlareDSGMaker
...
{
    printf("MakeChunk version %s\n",version);
    printf("Using toollib %s %s\n", tlversion, tlCompileInfo);
    puts( "\nCopyright Radical Entertainment 2002\n\n"
            "   Usage: MakeChunk [options] <inputfile> [<inputfile> ...]\n\n"
         "???\n"
            "\n"
            "Try LensFlareDSGMaker --help for more info.\n");
    exit(1);
}
...
{
    printf("LensFlareDSGMaker version %s (with toollib %s)\n\n", version, tlversion);
...
Parameters::HistoryChunk()
{
    tlHistory history;
    char buf[512];
    sprintf(buf,"LensFlareDSGMaker version %s (with toollib %s)", version, tlversion);
    history.AddLine(buf);
    char* b = buf;
    int i;
    for( i = 0; i < Argc; i++)
