...
p4 edit ../../distribution/p3dParticleSystem/Maya4.0/...
p4 edit ../../distribution/Maya4.0/...

copy /Y Release4\*.mll ..\..\distribution\p3dParticleSystem\maya4.0\bin\plug-ins
copy /Y mel\*.mel ..\..\distribution\p3dParticleSystem\maya4.0\scripts\others
copy /Y icons\*.bmp ..\..\distribution\p3dParticleSystem\maya4.0\icons
copy /Y ..\common\mel\*.mel ..\..\distribution\p3dParticleSystem\maya4.0\scripts\others
...
p4 revert -a ../../distribution/p3dParticleSystem/Maya4.0/...