...
p4 edit ../../distribution/p3dBoundingVolume/Maya4.0/...
...
copy /Y .\icons\*.bmp ..\..\distribution\p3dBoundingVolume\maya4.0\icons
copy /Y .\mel\*.mel ..\..\distribution\p3dBoundingVolume\maya4.0\scripts\others
copy /Y Release4\*.mll ..\..\distribution\p3dBoundingVolume\maya4.0\bin\plug-ins
copy /Y ..\common\mel\*.mel ..\..\distribution\p3dBoundingVolume\maya4.0\scripts\others
...
p4 revert -a ../../distribution/p3dBoundingVolume/Maya4.0/...
