...
/*
 * Structure used to specify how to handle args options.
 */
...
typedef struct Tk_ConfigSpec {
    ...
    char *argvName;		/* Switch used to specify option in args.
...
typedef int (Tk_ImageCreateProc) _ANSI_ARGS_((Tcl_Interp *interp,
	char *name, int argc, Arg *args, Tk_ImageType *typePtr,
...
EXTERN int		Tk_ParseArgv _ANSI_ARGS_((Tcl_Interp *interp,
			    Tk_Window tkwin, int *argcPtr, Arg *args,
...
EXTERN int LangEventCallback _ANSI_ARGS_((Tcl_Interp *,Tk_Window,LangCallback *,XEvent *,KeySym));
