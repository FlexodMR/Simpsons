...
#include "../include/jm/jm_cfg.h"

#ifndef JM_NO_WCSTRING
#include "../include/jm/re_nls.h"
#include "../include/jm/re_thrd.h"
#include "../include/jm/re_str.h"
#include "../include/jm/re_mss.h"
#include "../include/jm/regex.h"
#include "../include/jm/re_lst.h"
#include "../include/jm/re_cls.h"
#include "../include/jm/re_coll.h"
...
JM_IX_DECL void RE_CALL re_transform(re_str<wchar_t>& out, const re_str<wchar_t>& in)
{
   ...
   else
   {
      ...
      alt = new char[n+1];
      re_strnarrow((char*)alt, n+1, in.c_str());
   ...
   if(isPlatformNT)
      n = LCMapStringW(GetUserDefaultLCID(), LCMAP_SORTKEY, in.c_str(), -1, (wchar_t*)(char*)t, n);
   else
      n = LCMapStringA(GetUserDefaultLCID(), LCMAP_SORTKEY, (char*)alt, -1, (char*)t, n);
   int i = -1;
   do
   {
      ++i;
