...
#ifdef RE_LOCALE_CPP
   char_class_none = 0,
   char_class_alnum = JM_STD::ctype_base::alnum,
   char_class_alpha = JM_STD::ctype_base::alpha,
   char_class_cntrl = JM_STD::ctype_base::cntrl,
   char_class_digit = JM_STD::ctype_base::digit,
   char_class_graph = JM_STD::ctype_base::graph,
   char_class_lower = JM_STD::ctype_base::lower,
   char_class_print = JM_STD::ctype_base::print,
   char_class_punct = JM_STD::ctype_base::punct,
   char_class_space = JM_STD::ctype_base::space,
   char_class_upper = JM_STD::ctype_base::upper,
   char_class_xdigit = JM_STD::ctype_base::xdigit,
   char_class_blank = 1<<12,
   char_class_underscore = 1<<13,
   char_class_word = JM_STD::ctype_base::alnum | char_class_underscore,
...
JM_IX_DECL extern wchar_t re_lower_case_map_w[];
...
#ifdef RE_LOCALE_CPP
JM_IX_DECL JM_STD::string RE_CALL re_get_error_str(unsigned int id, const JM_STD::locale&);
#endif
...
{
#ifdef RE_LOCALE_CPP
   return JM_USE_FACET(l, JM_STD::ctype<char>).tolower(c);
#else
...
{
#ifdef RE_LOCALE_CPP
   return JM_USE_FACET(l, JM_STD::ctype<wchar_t>).tolower(c);
#else
...
//
template <class charT>
unsigned int RE_CALL re_toi(const charT c
#ifdef RE_LOCALE_CPP
, const JM_STD::locale& l
#endif
)
...
unsigned int RE_CALL re_toi(iterator& first, iterator last, int radix
#ifdef RE_LOCALE_CPP
, const JM_STD::locale& l
#endif
)
...
extern JM_IX_DECL const char* regex_message_catalogue;
