...
class CTC : public CMultiTree
{
	...
	friend class CMultiTreeView;
};

/////////////////////////////////////////////////////////////////////////////
// CMultiTreeView view

#define CMultiTreeView_BASE		CTreeView

class CMultiTreeView : public CMultiTreeView_BASE
{
protected:
	CMultiTreeView();           // protected constructor used by dynamic creation
	DECLARE_DYNCREATE(CMultiTreeView)
