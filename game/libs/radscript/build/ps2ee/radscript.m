...
radscript_x :
	...
	@echo ------------------------------
	@$(ROOTDIR)/radbuild/globaltools/make --no-print-directory -r -C $(ROOTDIR)/radscript/build/ps2ee

radscript_x_clean :
	@echo Cleaning radscript library ...
	@echo ------------------------------
	@$(ROOTDIR)/radbuild/globaltools/make --no-print-directory -r -C $(ROOTDIR)/radscript/build/ps2ee clean
